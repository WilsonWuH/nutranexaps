...
- Date: 2026-08-11
- Published At: 2026-08-11T18:00:00Z
- Audience: North American ingredient importers, distributors, supplement manufacturers, functional food brands, procurement managers, logistics teams, and quality teams who buy bulk phosphatidylserine (PS) and need to decide how to protect ocean shipments, review seller-provided insurance, and handle damage or shortage claims.
- Content goal: Answer the real buyer question of how US and Canada importers should review marine cargo insurance for PS ocean shipments, including the gap between carrier liability and cargo policy cover, CIF versus CIP insurance levels under Incoterms 2020, Institute Cargo Clauses A/B/C, certificate review, and the claims workflow.
- Topic selection note: At run start, the two 2026-08-11 cycle companions live on production were `Phosphatidylserine RASFF Monitoring: A European Buyer Due-Diligence Guide` (EU regulatory-monitoring lane) and `Phosphatidylserine FDA Inspection History Review for US Buyers` (US regulatory-history lane). This article intentionally moves to a distinct North American purchasing and shipment-protection trigger: marine cargo insurance review for PS imports. A grep of the full resource library confirms no existing article covers marine cargo insurance, COGSA carrier limits, CIF/CIP insurance levels, Institute Cargo Clauses, cargo insurance certificates, or cargo claims as its main topic; the Incoterms Europe and payment-terms Europe articles mention insurance only in passing, the pre-shipment inspection and export-documentation articles cover condition and packing evidence, and the incoming-inspection article covers receiving. No keyword cannibalization.
- Primary Keyword: phosphatidylserine marine cargo insurance
- Secondary Keywords:
  - PS ocean freight insurance US Canada
  - COGSA carrier liability PS shipments
  - CIF vs CIP phosphatidylserine import
  - Institute Cargo Clauses review PS
  - PS cargo insurance certificate checklist
- Long-tail Keywords:
  - what marine cargo insurance covers for a phosphatidylserine shipment
  - is CIF insurance enough for a PS drum order
  - what is the COGSA 500 dollar package limit for ingredient imports
  - how to review a PS cargo insurance certificate
  - open cargo policy vs single shipment certificate for PS importers
  - what to do after PS cargo damage or short delivery
- AI Overview / GEO Question Targets:
  - What is the difference between CIF and CIP insurance cover?
  - What does the USD 500 COGSA package limitation mean for importers?
  - What do Institute Cargo Clauses A, B, and C cover?
  - Do importers need their own marine cargo insurance when buying CIF?
  - What should a cargo insurance certificate show for an ingredient shipment?
  - How do you file a marine cargo claim for a damaged supplement ingredient shipment?
- Search Intent: High-intent North American shipment-risk review before purchase order, Incoterm selection, and shipment release
- Funnel Stage: Order confirmation, Incoterm and insurance decision, shipment monitoring, and claims readiness
- SEO Title: Phosphatidylserine Marine Cargo Insurance Review | Nutranexa
- Meta Description: How US and Canada importers review marine cargo insurance for phosphatidylserine: COGSA limits, CIF vs CIP, cargo clauses, certificates, and claims.
- URL Slug: /resources/phosphatidylserine-marine-cargo-insurance-us-canada/
- H1: Phosphatidylserine Marine Cargo Insurance Review for US and Canada Importers

## Introduction

Every ocean shipment of bulk [phosphatidylserine](/products/phosphatidylserine/) (PS) carries two very different protections: the carrier's liability under the bill of lading, which is small and heavily qualified, and cargo insurance, which is a contract the buyer can actually rely on. **The direct answer for a US or Canada importer is to treat marine cargo insurance as a separate purchasing decision: confirm what each quoted Incoterm includes, check that the insurance certificate names your interest and covers the full commercial value from warehouse to warehouse at a level of cover that matches the risk, and keep the certificate, bill of lading, commercial invoice, packing list, and COA together, because a claim without that document set is very hard to prove.** Carrier default liability is not insurance: under the US Carriage of Goods by Sea Act (COGSA), the carrier's liability is capped at USD 500 per package unless a higher value is declared in the bill of lading, which for a 25 kg drum of PS is usually a small fraction of its commercial value.
...
COGSA, codified at [46 U.S.C. § 30701](https://www.law.cornell.edu/uscode/text/46/30701) with its statutory text carried as a note, applies to ocean carriage to and from US ports. Its core limitation: neither the carrier nor the ship is liable for loss or damage in excess of USD 500 per package or per customary freight unit, unless the shipper declared a higher value before shipment and it was inserted in the bill of lading.

Four details matter to a PS importer:

1. **The limit is per package, not per shipment.** Whether a drum, pallet, or container counts as the package can turn on the bill of lading description, so read it before the bill is issued.
2. **The carrier has a list of defenses.** COGSA relieves the carrier from liability for causes including insufficient packing, inherent defect or vice of the goods, perils of the sea, and acts of God. A claim that fails against the carrier can still succeed against cargo insurance.
3. **Deadlines are short.** Written notice of non-apparent damage to the carrier is normally due within three days of delivery, and suit must be brought within one year.
4. **Declaring value is possible but rare.** A shipper can declare a higher value and pay an ad valorem charge, but that only raises the carrier limit; it does not create a cargo policy.

Canadian water carriage is governed by the [Carriage of Goods by Water Act (S.C. 1993, c. 21)](https://publications.gc.ca/site/eng/9.522916/publication.html), which implements the Hague-Visby Rules with its own package-level limitation. The number differs from the US rule, but the conclusion is the same: the carrier's default liability is small and conditional, and cargo insurance protects the full value. Parties that issue bills of lading for US trade, including ocean freight forwarders and NVOCCs, are regulated by the Federal Maritime Commission as [ocean transportation intermediaries](https://www.fmc.gov/resources/ocean-transportation-intermediaries/), but that regime is not cargo insurance.

## CIF vs CIP: What the Incoterms Actually Promise

[Incoterms 2020](https://iccwbo.org/business-solutions/incoterms-rules/), in force since 1 January 2020, set explicit insurance obligations for CIF and CIP, and the two rules are different:
...
The seller's insurance under CIF or CIP is arranged for the buyer's benefit, and the seller must provide a policy or certificate that lets the buyer claim directly from the insurer. The 110% floor may not match the full landed value the buyer needs; importers with their own cargo program can add difference-in-conditions cover. The [ICC Academy's CPT or CIP guide](https://academy.iccwbo.org/incoterms/article/incoterms-2020-cpt-or-cip/) explains the same obligation for multimodal routes.

## Institute Cargo Clauses A, B, and C

Most ocean cargo policies for ingredient imports are written on the Institute Cargo Clauses, issued by the [Joint Cargo Committee](https://lmalloyds.com/committee/joint-cargo-committee/) of the Lloyd's Market Association and the International Underwriting Association; the 2009 revision has been effective since 1 January 2009 and is available through the [London Market clauses library](https://www.iua.co.uk/IUA_Member/IUANew/Clauses_Documents/Clauses-Search.aspx). North American buyers may instead see the [AIMU cargo forms](https://www.aimu.org/resources/formsmenu/aimu-cargo-clauses-background-explanantion.html), whose 2004 series includes All Risks, FPAAC, FPAEC, and With Average.
...
The certificate is only useful inside a complete shipment file. Keep it with the bill of lading, commercial invoice, packing list, and the lot-specific COA, so the adjuster can confirm what was shipped, what it was worth, and its condition when it left the factory. The same discipline that supports [export documentation review](/resources/phosphatidylserine-export-documentation-ispm15-review-us-eu/) and [incoming inspection and warehouse release](/resources/phosphatidylserine-incoming-inspection-warehouse-release/) is what makes a claim resolvable.

Need current PS specifications, COA evidence, and packaging or dispatch imagery to share with your broker and insurer? [Request the document set](/contact/).
...
1. **Notify the broker and insurer immediately in writing**, noting the vessel, bill of lading number, and what was found.
2. **Preserve the evidence** - drums, packing, seals, and recovered powder - and photograph everything before anything is moved.
3. **Get exceptions onto the delivery record**, or arrange a short-landing certificate; a clean receipt makes later claims harder.
4. **Arrange a survey** with the insurer or jointly with the carrier, and keep the report.
5. **Assemble the document set**: certificate or policy, bill of lading, commercial invoice, packing list, lot-specific COA, pre-shipment inspection records, dispatch photos, and survey report.
6. **File the claim in writing** with an itemized loss and attached documents, and watch every deadline: COGSA-type rules expect written notice to the carrier within three days for non-apparent damage and suit within one year, and the policy has its own notice requirements.
7. **Quarantine affected lots** until inspection is closed so no damaged stock reaches production.
...
- File insurance documents with the [HS code and customs review](/resources/phosphatidylserine-hs-code-review-us-canada/) and [customs broker handoff](/resources/phosphatidylserine-customs-broker-handoff-us/) files.
- Review the insurance position during [MOQ and packaging planning](/resources/phosphatidylserine-moq-packaging-lead-time/), because drum count and pallet pattern change what the certificate should say.
...
Ready to plan your next PS shipment? [Contact Nutranexa sales](/contact/) with your source preference, target assay, destination market, Incoterm, and estimated quantity.
...
- [Cornell Law School LII: 46 U.S. Code § 30701 (COGSA text)](https://www.law.cornell.edu/uscode/text/46/30701)
- [Federal Maritime Commission: Ocean Transportation Intermediaries](https://www.fmc.gov/resources/ocean-transportation-intermediaries/)
- [ICC: Incoterms 2020 rules](https://iccwbo.org/business-solutions/incoterms-rules/)
- [ICC Academy: Incoterms 2020 - CPT or CIP](https://academy.iccwbo.org/incoterms/article/incoterms-2020-cpt-or-cip/)
- [Lloyd's Market Association: Joint Cargo Committee](https://lmalloyds.com/committee/joint-cargo-committee/)
- [International Underwriting Association: Clauses eLibrary](https://www.iua.co.uk/IUA_Member/IUANew/Clauses_Documents/Clauses-Search.aspx)
- [American Institute of Marine Underwriters: AIMU Cargo Clauses background](https://www.aimu.org/resources/formsmenu/aimu-cargo-clauses-background-explanantion.html)
- [Government of Canada Publications: Carriage of Goods by Water Act (S.C. 1993, c. 21)](https://publications.gc.ca/site/eng/9.522916/publication.html)
...
- Featured image concept: A wide daylight flat illustration of a port-adjacent logistics office for US and Canada importers: a sealed plain 25 kg PS drum on a pallet in the foreground, an open cargo-policy binder with three blank coverage tabs marked by green, amber, and blue markers, a single-shipment insurance certificate card under a magnifier, a small anchor-and-shield motif on the binder cover, and a container vessel alongside a port terminal visible through the office window in the background. No logos, readable text, certification marks, or fake data; visually distinct from the ISF vessel-at-dusk, DWPE gate, EU customs board, payment-rails desk, and all other existing resource images by using the policy-binder and certificate-review composition in a daylight office with the port outside the window.
