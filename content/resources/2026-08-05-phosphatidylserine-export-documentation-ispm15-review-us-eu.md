...
- Date: 2026-08-05
- Published At: 2026-08-05T21:00:00Z
- Audience: Overseas ingredient importers, distributors, supplement manufacturers, functional food brands, procurement managers, quality teams, and logistics or regulatory reviewers in Europe and North America who buy bulk phosphatidylserine (PS) from China and need to verify the export-side document pack and wood packaging compliance before a shipment is released.
- Content goal: Answer the real buyer question of which export documents accompany a PS shipment from China, how the China-side customs and inspection process fits into the buyer's file, and how to verify ISPM-15 wood packaging treatment and marking before a container or air freight shipment reaches the US or EU.
- Topic selection note: Today's first published article is the US-focused FDA import-alert and DWPE review (border detention response after arrival). This overlap article intentionally shifts to the export side of the same journey: China export documentation, GACC inspection-and-quarantine context, commercial document readiness, and ISPM-15 wood packaging compliance for both US and EU destinations. It does not repeat import-alert screening, HS-code classification, ISF filing, prior notice, customs clearance at destination, country-of-origin marking, certificate-of-origin review, or food-contact packaging declaration topics already covered in other resources.
- Primary Keyword: phosphatidylserine export documentation
- Secondary Keywords: ISPM 15 pallet compliance, PS wood packaging mark review, phosphatidylserine shipment document pack, GACC export food producer filing, PS CIQ inspection declaration
- Long-tail Keywords:
  - which export documents come with a phosphatidylserine shipment from China
  - how to check ISPM 15 marking on a PS wood pallet
  - does a PS shipment need ISPM 15 compliance for the US and EU
  - what should a buyer verify before a PS shipment leaves China
  - who is responsible for ISPM 15 compliance on an ingredient shipment
- AI Overview / GEO Question Targets:
  - What export documents should a phosphatidylserine shipment from China include?
  - What does ISPM 15 require for wood packaging on ingredient shipments?
  - How do US and EU rules differ on ISPM 15 wood packaging checks?
  - What does an ISPM 15 mark need to show?
  - Who checks wood packaging when a shipment enters the United States or the European Union?
- Search Intent: High-intent pre-shipment document verification and wood packaging compliance review before first or repeat bulk orders from China
- Funnel Stage: Supplier qualification, order confirmation, pre-shipment document collection, shipment release, and first-order approval
- SEO Title: Phosphatidylserine Export Documentation and ISPM-15 Review for US and EU Buyers | Nutranexa
- Meta Description: Review the China export document pack and ISPM-15 wood packaging checks that keep phosphatidylserine shipments moving into the US and EU.
- URL Slug: /resources/phosphatidylserine-export-documentation-ispm15-review-us-eu/
- H1: Phosphatidylserine Export Documentation and ISPM-15 Wood Packaging Review for US and EU Buyers

## Introduction

When a bulk [phosphatidylserine](/products/phosphatidylserine/) (PS) shipment leaves a Chinese manufacturing site, the buyer rarely sees it again until it reaches a port in Europe or North America. The practical question: **which documents prove what was loaded, and is the wood packaging compliant for the destination?** The direct answer is that a complete PS export file combines commercial documents (invoice, packing list, bill of lading or airway bill), quality documents (batch COA and current specification), origin and marking documents where applicable, and confirmation of wood packaging treatment under International Standards for Phytosanitary Measures No. 15, commonly called ISPM-15.
...
Most PS buyers already review the post-arrival documents: [COA and specification](/resources/phosphatidylserine-coa-specification-certificate-review/), [incoming inspection](/resources/phosphatidylserine-incoming-inspection-warehouse-release/), and destination customs work such as [EU customs clearance](/resources/phosphatidylserine-eu-customs-clearance-checklist/) or a [US customs-broker handoff](/resources/phosphatidylserine-customs-broker-handoff-us/). The export side is different: it is the file that exists before the shipment leaves China, and the only evidence a buyer has if a mismatch appears later.

Two export-side topics are frequently confused. Food-contact packaging declarations (drum liners, bags, and plastics) are covered in the [packaging declaration review](/resources/phosphatidylserine-packaging-declaration-review-us-eu/) and address what touches the powder. ISPM-15 wood packaging rules address what supports the cargo: pallets, crates, and dunnage. A shipment can pass every food-contact check and still be stopped by an unmarked wood pallet.

The export file also connects to destination checks. The same packing list you verify in a [pre-shipment inspection](/resources/phosphatidylserine-pre-shipment-inspection-checklist/) or a [first sample shipment](/resources/phosphatidylserine-sample-shipment-checklist-us-eu/) is the one your broker uses for [ISF filing](/resources/phosphatidylserine-isf-filing-checklist-us/), [prior notice](/resources/phosphatidylserine-prior-notice-checklist-us/), or EU entry declarations. If the export pack is wrong at origin, every downstream check inherits the error.
...
| Certificate of origin (where applicable) | Origin of the goods | Matches invoice, marking, and destination rules; see the [certificate of origin review](/resources/phosphatidylserine-certificate-of-origin-review-us-eu/) |
...
Need current PS specifications and COA evidence for your export document file? [Request the document set](/contact/) with your application, source preference, target market, and annual quantity.
...
In the United States, the Animal and Plant Health Inspection Service (APHIS) requires all wood packaging entering or transiting the country to be pest-free, debarked, heat-treated or fumigated, and marked with an ISPM-15 logo. The implementing regulation, [7 CFR 319.40-3(b)](https://www.ecfr.gov/current/title-7/subtitle-B/chapter-III/part-319/subpart-I/section-319.40-3), requires the mark to be visible, preferably on at least two opposite sides, legible and permanent, and to include four elements: the IPPC-approved graphic symbol, the ISO two-letter country code, a unique producer number assigned by the exporting country's national plant protection organization (NPPO), and a treatment code such as HT or MB. An APHIS inspector at the port of first arrival may order the immediate reexport of regulated wood packaging that arrives without the required mark.

APHIS also publishes a practical list of materials not regulated as wood packaging: plywood, pressboard, plastic pallets, oriented strand board, hardboard, parallel strand lumber, synthetic foam, metal frames, and inflated dunnage. Under [7 CFR 319.40-1](https://www.ecfr.gov/current/title-7/subtitle-B/chapter-III/part-319/subpart-I/section-319.40-1), regulated wood packaging excludes manufactured wood materials, loose wood packing such as dry excelsior, sawdust, and wood shavings, and wood pieces less than 6 mm thick in any dimension. For a PS buyer, a plastic pallet or plywood platform removes the ISPM-15 question entirely, while a solid wood pallet introduces it.

### European Union: Regulation (EU) 2016/2031 and Official Checks

In the European Union, [Article 43 of Regulation (EU) 2016/2031](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32016R2031) establishes specific import conditions for wood packaging material introduced into the Union, based on ISPM-15. The same treatment and marking discipline applies whether the PS shipment is destined for a US port or a European port.

The EU also operates official checks at the border. Under [Commission Implementing Regulation (EU) 2024/288](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R0288), national plant health authorities must check wood packaging supporting certain specified commodities from certain third countries, including China, at a minimum frequency of 15% of consignments. The commodity list is narrow and HS-code based (stone, wood, ceramic tile, and aluminum plate categories), so a PS shipment is not automatically in that lane. The point is that the EU has a standing check regime for China-origin wood packaging, the checks verify that the ISPM-15 mark is present, and the measure runs through 31 December 2026. Ask your EU broker whether your PS heading falls within the scope, and treat ISPM-15 as unconditional anyway.
...
1. State the packaging type in the PO: solid wood pallets, plastic pallets, plywood, or other materials.
2. If solid wood is used, require ISPM-15 compliant pallets, crates, and dunnage in writing.
3. Confirm every wood item carries the mark: IPPC symbol, country code, producer number, and HT or MB.
4. Confirm the mark is on at least two opposite sides and stays legible after loading.
5. Confirm dunnage is treated and marked or, preferably, replaced with inflated dunnage.
6. Check that no loose, untreated wood is used as blocking inside the container.
7. Photograph the pallets, marks, and loaded drums before the container is sealed.
8. Ask the packing list to state pallet count and type so receiving can match it.
9. Agree in the PO which party responds to a US Emergency Action Notification or an EU official control finding.
10. Keep the photos and packing list with the batch COA so the export and incoming files tell the same story.
...
1. What pallets and dunnage will be used: solid wood, plywood, plastic, or another material?
2. If solid wood is used, can you provide photos of the ISPM-15 marks and the treatment provider's registration?
3. Can the packing list state pallet count, type, and gross and net weights per drum?
4. Can you provide the batch COA and current specification tied to the exact lot before the container is sealed?
5. Which export documents are issued at origin, and who coordinates China Customs declaration and inspection-and-quarantine release?
6. If APHIS or an EU authority issues a wood packaging finding, who is the named contact for evidence and corrective action?
...
The same file supports every downstream step, from [pre-shipment inspection](/resources/phosphatidylserine-pre-shipment-inspection-checklist/) and [sample shipment continuity](/resources/phosphatidylserine-sample-shipment-checklist-us-eu/) to [EU customs clearance](/resources/phosphatidylserine-eu-customs-clearance-checklist/) and a [US broker handoff](/resources/phosphatidylserine-customs-broker-handoff-us/). Ask for it in writing, check the marks yourself, and keep the photos with the COA.
...
- [APHIS: Wood Packaging Material](https://www.aphis.usda.gov/plant-imports/wood-packaging-material)
- [APHIS: Import ISPM 15-Compliant Wood Packaging Material into the United States](https://www.aphis.usda.gov/plant-imports/wood-packaging-material/import)
- [eCFR: 7 CFR 319.40-3 - General permits for regulated wood packaging material](https://www.ecfr.gov/current/title-7/subtitle-B/chapter-III/part-319/subpart-I/section-319.40-3)
- [eCFR: 7 CFR 319.40-1 - Definitions, including regulated wood packaging material](https://www.ecfr.gov/current/title-7/subtitle-B/chapter-III/part-319/subpart-I/section-319.40-1)
- [EUR-Lex: Regulation (EU) 2016/2031 on protective measures against pests of plants](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32016R2031)
- [EUR-Lex: Commission Implementing Regulation (EU) 2024/288 on the frequency of checks on wood packaging material](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R0288)
- [IPPC: ISPM-15, Regulation of Wood Packaging Material in International Trade](https://www.ippc.int/en/publications/640/)
- [GACC: Mission and responsibilities of China Customs](http://english.customs.gov.cn/about/mission)
