...
- Date: 2026-08-06
- Published At: 2026-08-06T22:30:00Z
- Audience: US supplement manufacturers, private-label brands, contract manufacturers, ingredient distributors, and their procurement, quality, and regulatory teams who buy bulk phosphatidylserine (PS) and need a defensible answer on which samples to retain under 21 CFR Part 111 and for later claim investigation.
- Content goal: Answer the real buyer question of what representative-sample and reserve-sample obligations apply when PS is used in US dietary supplements, how to build a retained-sample protocol for imported PS, and what to ask the supplier about batch retention.
- Topic selection note: The two already-published articles in this cycle are the Europe-facing stability-study guide and the US-EU mycotoxin testing review, both analytical quality lanes. This article intentionally moves to a distinct North American quality-control trigger: sample retention and reserve-sample readiness under 21 CFR Part 111 for US buyers. A grep of the full resource library confirms no existing article covers representative samples, reserve samples, retained samples, or retention periods as its main topic; the closest references are a retained-samples clause inside the supplier-quality-agreement review and passing mentions in the incoming-inspection and stability articles. There is no keyword cannibalization with the stability, mycotoxin, COA, incoming-inspection, lot-traceability, sample-approval, or third-party-testing pages.
- Primary Keyword: phosphatidylserine reserve samples
- Secondary Keywords: PS reserve sample requirements, 21 CFR 111 reserve samples, dietary supplement component samples, PS retained samples US, PS supplier retain sample policy
- Long-tail Keywords:
  - do supplement manufacturers need reserve samples of phosphatidylserine
  - what are the reserve sample requirements under 21 CFR 111
  - how long must reserve samples be kept for dietary supplements
  - how much sample should buyers retain from an incoming PS lot
  - should PS suppliers keep retained samples of each batch
- AI Overview / GEO Question Targets:
  - Do dietary supplement manufacturers need reserve samples of ingredients or only finished products?
  - What are the representative and reserve sample requirements under 21 CFR Part 111?
  - How long must reserve samples be retained?
  - How much reserve sample is required for a dietary supplement lot?
  - What storage conditions apply to reserve samples?
  - Should a phosphatidylserine supplier keep retained samples of every batch?
- Search Intent: High-intent quality-control planning before the first bulk order, supplier qualification, quality-agreement negotiation, incoming inspection, and audit readiness
- Funnel Stage: Supplier qualification, specification and COA review, quality agreement, incoming inspection, and audit preparation
- SEO Title: Phosphatidylserine Reserve Samples: US Supplement GMP Review | Nutranexa
- Meta Description: Learn US reserve-sample requirements under 21 CFR Part 111, what to retain when buying phosphatidylserine, and how to set a supplier retained-sample policy.
- URL Slug: /resources/phosphatidylserine-reserve-samples-us/
- H1: Phosphatidylserine Reserve Samples: A US Supplement GMP Review for Buyers

## Introduction

A quality team buying bulk [phosphatidylserine](/products/phosphatidylserine/) (PS) for a US dietary supplement usually asks the same question: which samples do we have to keep, and who keeps them? **The direct answer: 21 CFR Part 111 requires you to collect representative samples of each unique lot of components such as PS for specification verification, and reserve samples of each lot of packaged and labeled dietary supplements that you distribute; it does not impose a separate Part 111 reserve-sample duty on the PS ingredient itself.** That distinction matters because it tells buyers exactly where the regulatory obligation starts and ends, and where a voluntary retained-sample protocol should fill the gap.

This article is written for North American importers, supplement manufacturers, private-label brands, contract manufacturers, and distributors sourcing PS as a bulk ingredient. It explains what the regulations actually say, what that means for a lecithin-derived powder bought in [25 kg drums](/products/phosphatidylserine/), how to build a practical retained-sample protocol for incoming PS lots, and which supplier-side retention questions belong in a [supplier quality agreement](/resources/phosphatidylserine-supplier-quality-agreement-us-eu/). This is a quality-control and document review, not a medical discussion.

Where Nutranexa is mentioned, only verified public facts are used. Nutranexa identifies itself as Shandong Nutranexa Biopharmaceutical Co., Ltd., founded in 2013, operating a 110,000+ m2 campus, and primarily serving Europe and North America. Its public [PS product page](/products/phosphatidylserine/) covers [soy PS](/products/soy-phosphatidylserine/) and [sunflower PS](/products/sunflower-phosphatidylserine/), its [quality and R&D page](/quality-rd/) shows sample COA evidence, and its [manufacturing](/manufacturing/) and [packaging and dispatch](/cases/) pages show factory, packaging, and shipment context. The published PS minimum order is 25 kg with 25 kg net per drum.
...
For PS, sampling one drum is not automatically representative of a multi-drum lot. Your sampling plan should state how drums are selected, how much powder is taken, and whether samples are composited, so every result traces back to a specific lot. The [incoming inspection](/resources/phosphatidylserine-incoming-inspection-warehouse-release/) workflow is where this sample is usually taken, before the lot is released from quarantine.
...
For a powder ingredient and the finished products made from it, that means sealed containers, controlled temperature, protection from humidity, and protection from light. The [shelf-life and storage review](/resources/phosphatidylserine-shelf-life-storage-review-us-eu/) explains how buyers should verify the storage parameters behind a supplier's statement.
...
If your operation manufactures dietary supplements, PS arrives as a component. Before use you must verify its identity with at least one appropriate test or examination under § 111.75(a)(1)(i), and you must collect representative samples under § 111.80. The [supplier COA qualification review](/resources/phosphatidylserine-supplier-coa-qualification-us/) explains the narrow conditions under which a supplier COA can support the identity and specification decisions. Your reserve-sample obligation starts with the finished supplement lots you package, label, and distribute, not with the incoming ingredient.
...
A finished-lot reserve sample is only as useful as the lot identity behind it. When a customer complaint or an out-of-specification result forces an investigation, the finished reserve sample must be traceable back to the PS lot that went into it, the [COA](/resources/phosphatidylserine-coa-specification-certificate-review/), the incoming sample, and the shipment records. That is why the [lot traceability checklist](/resources/phosphatidylserine-lot-traceability-checklist/) is the natural companion to any retention program: reserve samples identify the batch, but the batch must connect to evidence.
...
- To give an independent laboratory something to verify when a [third-party test](/resources/phosphatidylserine-third-party-testing-us-eu/) is ordered.
...
1. **Define the lot and shipment unit.** Record the supplier lot code, the number of drums, the [COA](/resources/phosphatidylserine-coa-specification-certificate-review/) reference, and the shipment identifier so every sample is linked to one physical lot.
2. **Collect representative samples at receiving.** Take samples from sealed drums during [incoming inspection](/resources/phosphatidylserine-incoming-inspection-warehouse-release/), before the lot is released, following the sampling plan required by § 111.80.
3. **Fix the retained-sample quantity and container.** A common buyer practice is enough powder to repeat identity plus the key specification tests, for example 100-200 g per lot in a sealed, moisture-protected container. Your SOP should set the exact quantity; it is a buyer decision, not a Part 111 number for components.
4. **Label and log the sample.** Include the lot number, COA reference, quantity, collection date, storage location, custodian, and retention end date in a sample register.
5. **Store under controlled conditions.** Keep the sealed sample cool, dry, and protected from light, consistent with the storage guidance on the supplier's specification and the finished product label.
6. **Set the retention period.** Align it with the finished-lot reserve-sample obligation: at minimum, the finished shelf life plus an investigation window, and preferably through the 2-year distribution-based period where shelf-life dating is not used.
7. **Control disposal and investigations.** Document who may open a retained sample, keep a chain of custody when powder is sent for testing, and require sign-off before disposal.
...
These questions belong in supplier qualification and in the [supplier quality agreement](/resources/phosphatidylserine-supplier-quality-agreement-us-eu/), not in a verbal sales conversation. A supplier that can show a written batch-retention policy gives the buyer a much stronger investigation position.

## How to Write Retention Into the Quality Agreement

The quality agreement should name the retained-sample obligation explicitly. Useful clauses cover: which side keeps samples (supplier batch retain plus buyer incoming retain), the minimum retention period, storage conditions, identification requirements, release conditions for independent testing, and the evidence each side must provide when a quality claim is raised. The [supplier quality agreement review](/resources/phosphatidylserine-supplier-quality-agreement-us-eu/) shows how these clauses fit with traceability, deviation, and claim procedures.

For repeat orders, retention clauses also prevent quiet drift: if the supplier changes batch-retention policy, storage, or sample identification, the change should be documented under the same change-control discipline described in the [repeat-order document review](/resources/phosphatidylserine-repeat-order-document-review/).
...
Need current PS specifications, COA samples, and packaging details for your sample-retention review? [Request the specification and COA evidence](/contact/) with your source preference, target assay, and destination market.
...
- [eCFR: 21 CFR 111.80 - What representative samples must you collect?](https://www.ecfr.gov/current/title-21/chapter-I/subchapter-B/part-111/section-111.80)
- [eCFR: 21 CFR 111.83 - What are the requirements for reserve samples?](https://www.ecfr.gov/current/title-21/chapter-I/subchapter-B/part-111/section-111.83)
- [eCFR: 21 CFR 111.105 - What must quality control personnel do?](https://www.ecfr.gov/current/title-21/chapter-I/subchapter-B/part-111/section-111.105)
- [eCFR: 21 CFR 111.465 - What requirements apply to holding reserve samples of dietary supplements?](https://www.ecfr.gov/current/title-21/chapter-I/subchapter-B/part-111/section-111.465)
- [FDA: Small Entity Compliance Guide - Current Good Manufacturing Practice for Dietary Supplements (December 2010)](https://www.fda.gov/regulatory-information/search-fda-guidance-documents/small-entity-compliance-guide-current-good-manufacturing-practice-manufacturing-packaging-labeling)
- [Federal Register: Dietary Supplements: Current Good Manufacturing Practice final rule, 72 FR 34752 (June 25, 2007)](https://www.govinfo.gov/content/pkg/FR-2007-06-25/pdf/FR-2007-06-25.pdf)
