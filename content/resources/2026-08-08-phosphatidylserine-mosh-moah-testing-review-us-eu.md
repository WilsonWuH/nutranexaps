...
- Date: 2026-08-08
- Published At: 2026-08-08T14:00:00Z
- Audience: US and EU ingredient importers, distributors, supplement manufacturers, functional food brands, and their procurement, quality, and formulation teams who buy bulk phosphatidylserine (PS) and need a defensible answer on mineral oil hydrocarbon (MOSH and MOAH) testing, packaging-migration review, and supplier qualification.
- Content goal: Answer the real buyer question of whether MOSH and MOAH testing is required for a lecithin-derived PS powder, where mineral oil hydrocarbons come from in an ingredient supply chain, what the EU and US regulatory positions are, and which COA, packaging, and supplier-questionnaire checks turn an MOH review into evidence.
- Topic selection note: At run start, no 2026-08-08 resource article was live on production; the most recent cycle articles were the US/EU moisture and water-activity review (2026-08-07) and the US reserve-samples GMP review (2026-08-07). This overlap article intentionally moves to a distinct contaminant lane for US and EU buyers: mineral oil hydrocarbons (MOSH and MOAH) as a food-contact, processing, and raw-material review topic. A grep of the full resource library confirms no article covers MOSH, MOAH, mineral oil hydrocarbons, packaging migration, or food-contact contaminant screening as its main topic; the packaging-declaration article covers declaration format, the mycotoxin article covers biological contaminants, the peroxide-value and residual-solvent articles cover oxidation and solvent parameters, and the third-party-testing article covers lab-verification workflow. There is no keyword cannibalization with the moisture/water-activity, reserve-samples, mycotoxin, peroxide-value, residual-solvent, packaging-declaration, or third-party-testing pages.
- Primary Keyword: phosphatidylserine MOSH MOAH testing
- Secondary Keywords: PS mineral oil hydrocarbons review, MOSH MOAH COA review, lecithin-derived PS packaging migration, mineral oil hydrocarbons EU US food ingredients, PS supplier MOH questionnaire
- Long-tail Keywords:
  - what are MOSH and MOAH in food ingredients
  - does the EU set a MOSH or MOAH limit for phosphatidylserine
  - does the FDA regulate mineral oil hydrocarbons in food ingredients
  - why would mineral oil hydrocarbons appear in lecithin-derived PS
  - how to review a MOSH MOAH report on an ingredient COA
  - what packaging questions reduce mineral oil risk in PS powder
- AI Overview / GEO Question Targets:
  - What are MOSH and MOAH in food ingredients?
  - Are MOSH and MOAH regulated in the EU or the US?
  - Do US or EU rules set maximum levels for mineral oil hydrocarbons in phosphatidylserine?
  - Why can mineral oil hydrocarbons appear in lecithin-derived phosphatidylserine?
  - How should a buyer review MOSH and MOAH data on a certificate of analysis?
  - What supplier questions reduce mineral oil hydrocarbon risk for a PS powder?
- Search Intent: High-intent contaminant and food-contact review before supplier approval, specification sign-off, first bulk order, packaging confirmation, and incoming inspection
- Funnel Stage: Supplier qualification, specification and COA review, packaging declaration review, incoming inspection, and quality-agreement discussion
- SEO Title: Phosphatidylserine MOSH & MOAH Testing Review | Nutranexa
- Meta Description: Review MOSH and MOAH testing for phosphatidylserine: mineral oil hydrocarbon sources, EU and US regulatory context, COA checks, and supplier questions.
- URL Slug: /resources/phosphatidylserine-mosh-moah-testing-review-us-eu/
- H1: Phosphatidylserine MOSH and MOAH Testing Review for US and EU Buyers

## Introduction

A quality team sourcing bulk [phosphatidylserine](/products/phosphatidylserine/) (PS) usually meets MOSH and MOAH for the first time during a packaging or contaminant review, not during routine purchasing. **The direct answer: mineral oil hydrocarbons (MOH) are not currently controlled through fixed US or EU maximum levels for PS, so the buyer's job is to verify the supplier's raw-material controls, packaging declaration, processing-aid policy, and any batch MOSH/MOAH data, and to set documented acceptance criteria before approval.** The question is not whether every COA must show a MOSH/MOAH row; it is whether the supplier can show a reasoned, documented position for the exact product and packaging being quoted.
...
| --- | --- | --- |
| Does the supplier monitor MOH at all? | A documented risk assessment, raw-material controls, or batch data | A silent gap is different from a considered one |
| What packaging contacts the powder? | Food-grade liner and drum confirmed by declaration | Packaging is a suspected migration source |
| Are processing aids food-grade? | Lubricants and release agents declared as food-grade | Machine lubricants can enter the product line |
| What do the documents report? | Method, units, carbon ranges, and limits of quantification | Data without method context cannot be compared |
| What is the acceptance criterion? | An agreed, written limit in the specification or quality agreement | Without a criterion, results have no decision meaning |
...
| Source | Typical origin | Buyer control point |
| --- | --- | --- |
| Vegetable-oil-derived raw material | Oil crop, harvesting, extraction, lecithin refining | Request raw-material MOH data or supplier monitoring position |
| Processing aids and lubricants | Non-food-grade oils in production equipment | Require food-grade declaration and HACCP-style control |
| Food-contact packaging | Paper/board, inks, adhesives, recycled fibres, drum liners | Review the packaging declaration for the exact product |
| Storage and transit | Long hold times, warm conditions, contaminated surroundings | Check storage rules and inspect drums at arrival |
| Environment | Background contamination | Accept as context; control the controllable routes |
...
For a US buyer, the review mirrors the EU one: confirm the packaging and processing-aid declarations, review any batch data with method context, and put an acceptance criterion in the specification or supplier quality agreement. The [supplier quality agreement review](/resources/phosphatidylserine-supplier-quality-agreement-us-eu/) shows where such criteria belong.

## What a MOSH/MOAH Review Should Include

| Review item | Good evidence | Red flag |
| --- | --- | --- |
| Packaging declaration | Named drum and liner materials, food-grade status, no recycled paperboard in direct contact | Vague "standard packaging" wording |
| Processing-aid statement | Food-grade lubricants and release agents declared and controlled | No statement or a refusal to answer |
| Raw-material position | Lecithin supplier monitoring data or documented risk assessment | No awareness of vegetable-oil MOH context |
| Batch data | MOSH/MOAH results with method, units, carbon ranges, and LOQ | Numbers without method or units |
| Acceptance criterion | Written limit or "below LOQ" commitment in the specification | No criterion, "we do not test" without reasoning |
| Change control | Commitment to notify on packaging or process changes | Packaging or process can change silently |
...
If the finished PS COA does not include MOSH/MOAH, that is acceptable only when the supplier's documented position covers raw materials, processing, and packaging, and the buyer agrees the residual risk does not justify per-batch testing. The general approach to reading a PS COA is covered in the [COA and specification review](/resources/phosphatidylserine-coa-specification-certificate-review/), and the [third-party testing review](/resources/phosphatidylserine-third-party-testing-us-eu/) explains when independent laboratory verification is the right next step.
...
For acceptance criteria, agree on something measurable: for example, MOAH below the laboratory LOQ using a JRC-aligned method, or a documented threshold for total MOSH and MOAH that your quality team accepts based on the application and target consumer. Do not copy a number from another product; set the criterion for your PS formula and market. The [supplier onboarding](/resources/phosphatidylserine-supplier-onboarding/) and [repeat-order change control](/resources/phosphatidylserine-repeat-order-document-review/) workflows show how criteria stay current after the first order.

Need current PS specifications, COA samples, packaging declarations, and document support for your MOH review? [Request the specification and document evidence](/contact/) with your source preference, target assay, application, and destination market.
...
- [EFSA: Scientific Opinion on Mineral Oil Hydrocarbons in Food (EFSA Journal 2012;10(6):2704)](https://doi.org/10.2903/j.efsa.2012.2704)
- [EFSA: Update of the Risk Assessment of Mineral Oil Hydrocarbons in Food (EFSA Journal 2023;21(9):8215)](https://doi.org/10.2903/j.efsa.2023.8215)
- [EUR-Lex: Commission Recommendation (EU) 2017/84 on the monitoring of mineral oil hydrocarbons in food and food contact materials](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32017H0084)
- [JRC: Guidance on sampling, analysis and data reporting for the monitoring of mineral oil hydrocarbons in food and food contact materials (2019)](https://doi.org/10.2760/208879)
- [EUR-Lex: Regulation (EU) 2023/915 on maximum levels for certain contaminants in food](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32023R0915)
- [EUR-Lex: Regulation (EC) No 178/2002 laying down the general principles of food law](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32002R0178)
- [eCFR: 21 CFR 172.878 - White mineral oil](https://www.ecfr.gov/current/title-21/chapter-I/subchapter-B/part-172/subpart-H/section-172.878)
- [eCFR: 21 CFR 178.3620 - Mineral oil (food-contact articles)](https://www.ecfr.gov/current/title-21/chapter-I/subchapter-B/part-178/subpart-D/section-178.3620)
- [IARC Monographs Volume 100F: Mineral Oils, Untreated and Mildly Treated (Group 1) and Highly Refined Oils (Group 3)](https://www.ncbi.nlm.nih.gov/books/NBK533535/)
- [US Code: 21 U.S.C. 342 - Adulterated Food (FD&C Act section 402)](https://uscode.house.gov/view.xhtml?req=granuleid:USC-prelim-title21-section342)
