...
- Date: 2026-08-06
- Published At: 2026-08-06T22:00:00Z
- Audience: Overseas ingredient importers, distributors, supplement manufacturers, functional food brands, procurement managers, formulation teams, and quality teams in Europe and North America who buy bulk phosphatidylserine (PS) and need to decide whether mycotoxin testing belongs in their specification, COA, and supplier-qualification workflow.
- Content goal: Answer the real buyer question of whether US or EU rules set mycotoxin limits for PS, where aflatoxin and ochratoxin A risk sits in a lecithin-derived PS supply chain, how to read mycotoxin results on a COA, and which questions to put to a supplier before batch approval.
- Topic selection note: Today's first published article is the Safe Food for Canadians (SFCR) import licence review for Canadian buyers, a regulatory-preparation question at the Canadian border. This article intentionally moves to the analytical quality-control lane for US and EU buyers: mycotoxin testing and document review for lecithin-derived PS. A git grep over the full resource library confirms no existing article covers mycotoxins, aflatoxins, or ochratoxin A, so there is no keyword cannibalization with the heavy-metals, microbiological, pesticide-residue, residual-solvent, PAH, dioxin/PCB, 3-MCPD, or peroxide-value articles.
- Primary Keyword: phosphatidylserine mycotoxin testing
- Secondary Keywords: PS aflatoxin testing, PS ochratoxin A COA review, lecithin-derived PS mycotoxin risk, PS contaminant specification US EU, PS mycotoxin supplier questionnaire
- Long-tail Keywords:
  - does phosphatidylserine need mycotoxin testing
  - what aflatoxin limits apply to food in the EU
  - how to read mycotoxin results on a PS COA
  - what is the FDA aflatoxin action level for food ingredients
  - why are mycotoxins removed during lecithin refining
  - what mycotoxin questions should PS buyers ask suppliers
- AI Overview / GEO Question Targets:
  - Do US or EU regulations set mycotoxin limits for phosphatidylserine?
  - What aflatoxin maximum levels apply to food in the European Union?
  - What is the FDA aflatoxin action level for food?
  - Are mycotoxins a real risk in lecithin-derived phosphatidylserine?
  - How should a PS buyer review mycotoxin results on a certificate of analysis?
  - What sampling and analysis rules apply to mycotoxin control in the EU?
- Search Intent: High-intent quality-control and specification review before supplier approval, COA signoff, quality-agreement negotiation, and first bulk order
- Funnel Stage: Supplier qualification, specification review, COA/document review, quality agreement, incoming inspection, and repeat-order planning
- SEO Title: Phosphatidylserine Mycotoxin Testing Review for US and EU Buyers | Nutranexa
- Meta Description: Review mycotoxin testing for phosphatidylserine: aflatoxin and ochratoxin A limits, COA interpretation, and supplier questions for US and EU buyers.
- URL Slug: /resources/phosphatidylserine-mycotoxin-testing-us-eu/
- H1: Phosphatidylserine Mycotoxin Testing Review for US and EU Buyers

## Introduction

No US or EU regulation sets a mycotoxin maximum level specific to [phosphatidylserine](/products/phosphatidylserine/) (PS). **The direct answer: mycotoxin testing for PS is a specification, COA, and supplier-qualification discipline rather than a single legal number, and buyers should confirm whether the supplier's certificate of analysis covers aflatoxins (B1, B2, G1, G2) and ochratoxin A, what method and detection limit were used, and how the lecithin raw materials are controlled before conversion.** Because PS is made from refined lecithin, published assessments of commercial lecithin show very low aflatoxin levels.

This article is written for importers, distributors, supplement manufacturers, functional food brands, and their procurement and quality teams in Europe and North America. It explains which mycotoxins matter for a lecithin-derived ingredient, what the EU and US rules actually say, how to read a mycotoxin result on a PS COA, and which questions to put in an RFQ or [supplier quality agreement](/resources/phosphatidylserine-supplier-quality-agreement-us-eu/). This is a quality and document review, not a medical discussion.
...
**Aflatoxins** are a family of chemically related compounds, of which B1, B2, G1, and G2 are the main food-relevant forms. Aflatoxin B1 is the most potent and the anchor for most regulatory limits. In its 2020 risk assessment, the [EFSA Panel on Contaminants in the Food Chain](https://efsa.onlinelibrary.wiley.com/doi/10.2903/j.efsa.2020.6040) concluded that aflatoxins are genotoxic, that aflatoxin B1 can cause hepatocellular carcinomas in humans, and that exposures should be kept as low as reasonably achievable. This is why limits exist: the health concern is real, and the regulatory answer is prevention, control, and testing where contamination can occur.
...
For a buyer, mycotoxin review is about evidence: does the supplier test, how, at what quantification limit, and is the result on the batch COA or a separate report? That evidence belongs in the same folder as [COA and specification approval](/resources/phosphatidylserine-coa-specification-certificate-review/), [incoming inspection](/resources/phosphatidylserine-incoming-inspection-warehouse-release/), and [third-party verification](/resources/phosphatidylserine-third-party-testing-us-eu/).
...
1. Confirm whether the approved specification includes mycotoxin rows, and name the analytes (aflatoxin B1, total aflatoxins, ochratoxin A).
2. Ask for the current batch COA and check whether mycotoxin results appear on it or on a separate report.
3. Confirm the method and test basis, for example HPLC with fluorescence detection after immunoaffinity cleanup, LC-MS/MS, or a named internal method.
4. Confirm the LOD and LOQ, and read "not detected" against the LOQ.
5. Compare results with your stated limit, not with an assumed PS-specific legal limit that does not exist.
6. Decide which benchmark applies: the FDA 20 ppb total aflatoxin action level, the Ph. Eur. 2.8.18 2/4 µg/kg reference, or your own internal limit.
7. Ask whether the supplier tests every batch or periodic lots, and how results are documented.
8. Confirm raw-material controls: dried-soybean and sunflower sourcing, storage conditions, and refining steps at the lecithin stage.
9. Put the mycotoxin requirement, method, and LOQ into the [quality agreement](/resources/phosphatidylserine-supplier-quality-agreement-us-eu/) so future batches are released on the same evidence.
10. Connect the review to [incoming inspection](/resources/phosphatidylserine-incoming-inspection-warehouse-release/) and first-lot [third-party verification](/resources/phosphatidylserine-third-party-testing-us-eu/).

Steps 9 and 10 turn a one-time document check into ongoing control. A supplier that can state its mycotoxin policy in one sentence, with a named method and LOQ, makes approval straightforward; one that cannot should expect document questions before an order, just as it would for [heavy metals](/resources/phosphatidylserine-heavy-metals-review-europe/) or [pesticide residues](/resources/phosphatidylserine-pesticide-residue-review-europe/).

## What to Ask a PS Supplier About Mycotoxin Control

Add these questions to your RFQ and supplier questionnaire:

1. Does your current specification include mycotoxin limits, and for which analytes?
2. Which method and LOQ do you use for aflatoxin B1, total aflatoxins, and ochratoxin A?
3. Is mycotoxin testing performed on every batch, on periodic lots, or only on request?
4. How do you control raw-material risk before the lecithin stage, including sourcing and storage?
5. Can you provide recent batch COAs or mycotoxin reports for the quoted product route?
6. Will the quality agreement state the analytes, limits, methods, and LOQs so COA review stays consistent?
...
Nutranexa's verified public facts support the sourcing layer of this review. The company was founded in 2013, operates a 110,000+ m2 campus, primarily serves Europe and North America, and references R&D cooperation with East China University of Science and Technology. Public [product pages](/products/phosphatidylserine/) cover [soy PS](/products/soy-phosphatidylserine/) and [sunflower PS](/products/sunflower-phosphatidylserine/), the [manufacturing](/manufacturing/) and [packaging and dispatch](/cases/) pages show production and shipment evidence, and the PS MOQ is 25 kg with 25 kg net per drum.

The published [PS product page](/products/phosphatidylserine/) includes a specification matrix with identity, quality, and oxidation parameters, and the public sample COAs on the [quality and R&D page](/quality-rd/) state QB/T 5821-2023 as the test basis. The published samples do not show mycotoxin rows, so buyers should request the current batch report and confirm which analytes, methods, and limits apply to the quoted product route and source.

Need current PS specifications and COA evidence for your mycotoxin review? [Request the specification and COA sample](/contact/) with your source preference, target assay, and destination market.
...
- [EUR-Lex: Commission Regulation (EU) 2023/915 on maximum levels for certain contaminants in food](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32023R0915)
- [EUR-Lex: Commission Implementing Regulation (EU) 2023/2782 on methods of sampling and analysis for the control of mycotoxins in food](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32023R2782)
- [EFSA Journal: Risk assessment of aflatoxins in food (2020)](https://efsa.onlinelibrary.wiley.com/doi/10.2903/j.efsa.2020.6040)
- [PubMed: Risk assessment of aflatoxins in food (PMID 32874256)](https://pubmed.ncbi.nlm.nih.gov/32874256/)
- [EFSA Journal: Safety and efficacy of lecithins for all animal species (2016)](https://efsa.onlinelibrary.wiley.com/doi/full/10.2903/j.efsa.2016.4561)
- [Journal of the American Oil Chemists' Society: Absence of aflatoxin from refined vegetable oils](https://aocs.onlinelibrary.wiley.com/doi/abs/10.1007/BF02640803)
- [FDA: Chemical Contaminants Transparency Tool - Aflatoxins, total](https://hfpappexternal.fda.gov/scripts/fdcc/?set=contaminant-levels&id=Mycotoxin-02)
- [Federal Register: Availability of CPG Sec. 555.400, Aflatoxins in Human Food](https://www.federalregister.gov/documents/2021/06/01/2021-11388/compliance-policy-guide-sec-555400-aflatoxins-in-human-food-compliance-policy-guide-sec-570200)
- [eCFR: 21 CFR 111.70 - Requirements for establishing specifications](https://www.ecfr.gov/current/title-21/chapter-I/subchapter-B/part-111/section-111.70)
- [European Pharmacopoeia 2.8.18: Determination of aflatoxin B1 in herbal drugs](https://ehpm.org/wp-content/uploads/2022/04/QG22_2-8-18_Determination_of_aflatoxin_B1_in_herbal_drugs_ep10_2.pdf)
