...
- Date: 2026-08-09
- Published At: 2026-08-09T15:00:00Z
- Audience: US and EU ingredient importers, distributors, supplement manufacturers, functional food brands, and their procurement, quality, and formulation teams who buy bulk phosphatidylserine (PS) and need to review particle size distribution (PSD) data before specification sign-off, first bulk order, or incoming inspection.
- Content goal: Answer the real buyer question of how to review particle size distribution for a lecithin-derived PS powder: what D10/D50/D90 mean, how laser diffraction and analytical sieving differ, what a PSD row on a COA or specification should contain, when particle size matters for capsules, tablets, and powders, and how US and EU regulatory context affects the review.
- Topic selection note: At run start, the first 2026-08-09 article live on production was the US-focused structure/function claims resource (marketing-claims lane). This overlap article intentionally moves to the analytical specification-review lane for US and EU buyers: particle size distribution as a physical quality and application-fit parameter. A grep of the full resource library confirms no article is dedicated to particle size, PSD, D-values, sieve analysis, laser diffraction, or granulometry; the flowability article treats particle distribution as one powder property inside a blend pilot, the moisture article covers a separate parameter, and the COA-review article covers document structure generally. There is no keyword cannibalization with structure/function claims, flowability, moisture/water activity, COA review, incoming inspection, third-party testing, or powder-specification pages.
- Primary Keyword: phosphatidylserine particle size distribution
- Secondary Keywords: PS particle size, PS PSD specification, PS D50 COA review, lecithin-derived PS powder particle size, PS sieve analysis review
- Long-tail Keywords:
  - what is D50 in particle size distribution
  - how to read PSD on a certificate of analysis
  - laser diffraction vs sieve analysis for supplement powders
  - does particle size matter for capsule filling
  - what particle size should PS powder be for tablets
  - how to verify PS batch particle size consistency
- AI Overview / GEO Question Targets:
  - Does particle size matter for phosphatidylserine powder?
  - What is D50 on a certificate of analysis?
  - How is particle size distribution measured for supplement ingredients?
  - Should buyers ask for laser diffraction or sieve analysis for PS powder?
  - Do US or EU regulations set a particle size limit for phosphatidylserine?
  - When does particle size become a regulatory question in the EU or US?
- Search Intent: High-intent physical specification review before supplier approval, sample evaluation, first bulk order, formulation fit decisions, and incoming inspection
...
- SEO Title: Phosphatidylserine Particle Size Distribution Guide | Nutranexa
- Meta Description: Review phosphatidylserine particle size distribution for buying decisions: D10/D50/D90, sieve vs laser diffraction, COA checks, and supplier questions.
- URL Slug: /resources/phosphatidylserine-particle-size-distribution-review-us-eu/
- H1: Phosphatidylserine Particle Size Distribution Review for US and EU Buyers
...
| Application | What buyers check | Why it matters |
| --- | --- | --- |
| Hard capsules | D50, fines, distribution width, blend behavior | Fill-weight uniformity and segregation risk in the filling machine |
| Tablets | D50, coarse fraction, flow into the die | Consistent feeding and compression behavior |
...
| Functional foods | Dispersibility and texture | Fine or coarse profiles behave differently |
...
Particle size also interacts with other parameters: moisture changes cohesion, bulk density changes how much powder fits a fill volume, and shape and surface affect flow. That is why a PSD review belongs next to the [moisture and water activity review](/resources/phosphatidylserine-moisture-water-activity-review-us-eu/) and the [flowability and blend-uniformity pilot guide](/resources/phosphatidylserine-flowability-blend-uniformity-pilot/) rather than replacing them.
...
The US review is therefore specification-based: confirm the supplier defines particle size in the specification or quality agreement, verify data on incoming lots, and keep the [incoming inspection and warehouse release](/resources/phosphatidylserine-incoming-inspection-warehouse-release/) procedure aligned with the agreed method.
...
The [supplier onboarding](/resources/phosphatidylserine-supplier-onboarding/) and [supplier quality agreement](/resources/phosphatidylserine-supplier-quality-agreement-us-eu/) workflows are where PSD criteria should be recorded in writing, and the [documents for PS ingredients](/resources/documents-for-ps-ingredients/) checklist shows the full document set to hold.

## Supplier Questions and Acceptance Criteria

Add these questions to your supplier questionnaire:

1. Does the quoted grade have a defined particle size specification? If yes, provide the method, D-values, and limits.
2. Which method generated the data: laser diffraction or analytical sieving? Which chapter or standard was followed?
3. Can you provide PSD data for the current batch, and does it match the evaluated sample?
4. What routine control keeps particle consistency, and what triggers a recheck (new source, milling, process change)?
5. Is the product intentionally manufactured at nanoscale? If yes, what regulatory position applies?
6. Will the COA or a supporting report include the agreed PSD row or method statement on request?
7. What is the agreed acceptance range for D10, D50, and D90, including the fines fraction?
...
Need current PS specifications, COA samples, and particle data or method statements for your PSD review? [Request the specification and document evidence](/contact/) with your source preference, target assay, application, and destination market.
...
- [USP-NF <786> Particle Size Distribution Estimation by Analytical Sieving](https://doi.usp.org/USPNF/USPNF_M99584_01_01.html)
- [USP-NF <429> Light Diffraction Measurement of Particle Size](https://doi.usp.org/USPNF/USPNF_M99188_101010101_01.html)
- [EDQM: Ph. Eur. 2.9.31 Particle Size Analysis by Laser Light Diffraction](https://extranet.edqm.eu/4DLink1/4DCGI/Web_View/mono/20931)
- [EDQM: Ph. Eur. 2.9.38 Particle-Size Distribution Estimation by Analytical Sieving](https://extranet.edqm.eu/4DLink1/4DCGI/Web_View/mono/20938)
- [ISO 13320:2020 Particle Size Analysis - Laser Diffraction Methods](https://www.iso.org/standard/69111.html)
- [ISO 9276-1 Representation of Results of Particle Size Analysis - Graphical Representation](https://www.iso.org/standard/85959.html)
- [Federal Register: FDA Draft Guidance on Powder Blends and Finished Dosage Units - Stratified In-Process Dosage Unit Sampling and Assessment (2003)](https://www.federalregister.gov/documents/2003/11/07/03-28045/draft-guidance-for-industry-on-powder-blends-and-finished-dosage-units-stratified-in-process-dosage)
- [Federal Register: FDA Guidance on Considering Whether an FDA-Regulated Product Involves the Application of Nanotechnology (2014)](https://www.federalregister.gov/documents/2014/06/27/2014-15033/guidance-for-industry-considering-whether-a-food-and-drug-administration-regulated-product-involves)
...
- [EFSA: Guidance on Risk Assessment of Nanomaterials to be Applied in the Food and Feed Chain (EFSA Journal 2021;19(8):6768)](https://doi.org/10.2903/j.efsa.2021.6768)
- [EUR-Lex: Regulation (EU) 2015/2283 on Novel Foods](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32015R2283)
- [EUR-Lex: Commission Recommendation 2011/696/EU on the Definition of Nanomaterial](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32011H0696)
- [EUR-Lex: Regulation (EU) 1169/2011 on the Provision of Food Information to Consumers](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32011R1169)
