...
- Date: 2026-08-11
- Published At: 2026-08-11T20:00:00Z
- Audience: US and EU ingredient importers, distributors, supplement manufacturers, functional food brands, and their procurement, quality, and formulation teams who buy bulk phosphatidylserine (PS) and need to review the acetone-insoluble row on a specification or certificate of analysis before supplier approval, batch sign-off, or incoming inspection.
- Content goal: Answer the real buyer question of what acetone-insoluble matter means on a lecithin-derived PS specification and COA: what the test measures, how it is performed, which lecithin benchmarks exist in the EU and US, why a PS-grade limit is much higher than a lecithin limit, and how to review the result row and build a supplier questionnaire.
- Topic selection note: At run start, the 2026-08-11 articles live on production were the EU ICS2 pre-arrival filing guide (shipping-data lane) and the US/Canada marine cargo insurance review (logistics lane). This overlap article intentionally moves to the analytical specification-review lane for US and EU buyers: acetone-insoluble matter as a phospholipid-purity parameter of lecithin-derived PS powder. A grep of the full resource library confirms acetone-insoluble is only mentioned in passing as one COA line item inside COA review, sample evaluation, incoming inspection, pre-shipment, soy-vs-sunflower, repeat-order, contract-handoff, supplier-onboarding, PSD, and residual-solvent articles; no article is dedicated to acetone-insoluble testing, phospholipid purity, lecithin benchmarks, or the QB/T-based AI result row. There is no keyword cannibalization with particle size, moisture, peroxide value, residual solvent, mycotoxin, MOSH/MOAH, heavy metals, third-party testing, or COA-review pages.
- Primary Keyword: phosphatidylserine acetone insoluble
- Secondary Keywords: PS acetone insoluble specification; PS phospholipid purity COA review; acetone-insoluble matter lecithin test; PS 95 acetone insoluble; lecithin-derived PS purity review US EU
- Long-tail Keywords:
  - what is acetone-insoluble matter in phosphatidylserine
  - why is acetone insoluble on a PS certificate of analysis
  - what acetone-insoluble limit applies to lecithin E 322
  - how is acetone-insoluble matter measured in lecithin
  - what should a PS acetone-insoluble COA row contain
  - what questions should PS buyers ask about acetone insoluble
- AI Overview / GEO Question Targets:
  - What does acetone-insoluble matter mean on a phosphatidylserine certificate of analysis?
  - Why is acetone-insoluble content a purity test for lecithin-derived PS?
  - What is the acetone-insoluble limit for lecithin in the EU and US?
  - How is acetone-insoluble matter measured in lecithin-based ingredients?
  - What acetone-insoluble specification should a phosphatidylserine powder meet?
  - How should a buyer review the acetone-insoluble row on a PS COA?
- Search Intent: High-intent analytical specification and COA review before supplier qualification, batch approval, first bulk order, and incoming inspection
- Funnel Stage: Supplier qualification, specification and COA review, sample-to-bulk approval, incoming inspection, and quality-agreement discussion
- SEO Title: Phosphatidylserine Acetone Insoluble Review | Nutranexa
- Meta Description: Review acetone-insoluble matter on a phosphatidylserine COA: what the test measures, lecithin benchmarks, PS-grade limits, and supplier questions.
- URL Slug: /resources/phosphatidylserine-acetone-insoluble-review-us-eu/
- H1: Phosphatidylserine Acetone-Insoluble Matter Review for US and EU Buyers

## Introduction

When a quality team receives a [phosphatidylserine](/products/phosphatidylserine/) (PS) specification or certificate of analysis, the acetone-insoluble row is easy to skip. It is also one of the most informative purity checks on the page for a lecithin-derived powder. **The direct answer: acetone-insoluble matter measures the phospholipid-rich fraction of a lecithin-based ingredient; for a PS powder the buyer should confirm the test method, the limit in the product specification, the batch result on the COA, and the raw-material context, because a PS-grade limit of around 95% or higher is not the same as the 50-60% acetone-insoluble benchmark used for food-grade lecithin.**
...
Where Nutranexa is mentioned, only verified public facts are used. Nutranexa identifies itself as Shandong Nutranexa Biopharmaceutical Co., Ltd., founded in 2013, operating a 110,000+ m2 campus, cooperating with East China University of Science and Technology, and primarily serving export markets in Europe and North America. Its public [PS specification matrix](/products/phosphatidylserine/) shows an acetone-insoluble row of 95.0 g/100g or higher for the PS 20% sunflower and PS 50% grades, sample COA evidence with a QB/T 5821-2023 test basis is shown on the [Quality & R&D page](/quality-rd/), and its published minimum order is 25 kg with 25 kg net per drum.
...
| --- | --- | --- |
| Is the parameter defined? | Acetone-insoluble matter as a named test with a method reference | Different lecithin and PS methods exist and are not interchangeable |
| Is the limit product-specific? | The PS product specification limit, not the lecithin additive benchmark | A PS powder should show roughly 95% or higher, far above lecithin's 50-60% floor |
| Is the method named? | AOCS Ja 4-46, a pharmacopeia method, or the Chinese industry standard basis | The buyer can only repeat or verify a named method |
| Is the result tied to the batch? | Batch number, test date, and report date on the COA | The result must belong to the lot being evaluated |
| Is the raw material consistent? | Lecithin source and processing context for soy or sunflower PS | Acetone-insoluble control starts in the lecithin base |
...
| Framework | Substance | Acetone-insoluble requirement |
| --- | --- | --- |
| Regulation (EU) No 231/2012 | E 322 lecithins | Not less than 60.0% of substances insoluble in acetone |
| JECFA monograph | Lecithin, INS 322(i) | Not less than 60% of acetone-insoluble matter (phosphatides) |
| USP-NF Lecithin monograph | Lecithin | Not less than 50.0% of acetone-insoluble matter |
...
- **Contract review.** A US brand or contract manufacturer should confirm the acetone-insoluble limit in the [supplier quality agreement](/resources/phosphatidylserine-supplier-quality-agreement-us-eu/) and tie it to incoming release.

The practical US review is document-based: confirm the PS specification states the limit, the batch COA shows the method and result, and the [incoming inspection](/resources/phosphatidylserine-incoming-inspection-warehouse-release/) procedure checks the row against the acceptance criterion.
...
The EU review is therefore a specification and document review. The acetone-insoluble row on a PS COA should be read against the PS product limit, while the E 322 60% floor remains a useful raw-material context. Buyers who want independent confirmation can route the batch to a [third-party laboratory](/resources/phosphatidylserine-third-party-testing-us-eu/).
...
If any field is missing, request the complete current batch COA before release. The [documents for PS ingredients](/resources/documents-for-ps-ingredients/) checklist shows the full document set to hold, and the [sample evaluation and bulk approval](/resources/phosphatidylserine-sample-evaluation-bulk-approval/) workflow covers when a sample-level check becomes a batch-level commitment.
...
6. Will the specification and COA be committed in the [supplier quality agreement](/resources/phosphatidylserine-supplier-quality-agreement-us-eu/)?

For acceptance criteria, agree on the exact limit in the product specification, the named method, and the response when a result falls between the specification and the historical range. The [supplier onboarding](/resources/phosphatidylserine-supplier-onboarding/) workflow is the right place to record these decisions in writing.

Need current PS specifications, COA samples, and method statements for your acetone-insoluble review? [Request the specification and document evidence](/contact/) with your source preference, target assay, application, and destination market.
...
- [legislation.gov.uk: Commission Regulation (EU) No 231/2012, Annex - E 322 Lecithins specification](https://www.legislation.gov.uk/eur/2012/231/annex/division/108/adopted/data.xht)
- [FAO/WHO JECFA: Lecithin monograph (INS 322(i)), Combined Compendium of Food Additive Specifications](https://www.fao.org/fileadmin/user_upload/jecfa_additives/docs/monograph4/additive-250-m4.pdf)
- [USP-NF: Lecithin monograph (USP29-NF24), content of acetone-insoluble matter](http://ftp.uspbpep.com/v29240/usp29nf24s0_m44420.html)
- [AOCS: Official Method Ja 4-46, Acetone-Insoluble Matter in Vegetable Lecithins](https://library.aocs.org/Ja-4-46/)
- [eCFR: 21 CFR 184.1400 - Lecithin (GRAS, FCC specifications incorporated by reference)](https://www.ecfr.gov/current/title-21/chapter-I/subchapter-B/part-184/subpart-B/section-184.1400)
- [eCFR: 21 CFR 111.70 - Requirements for Establishing and Maintaining Specifications](https://www.ecfr.gov/current/title-21/chapter-I/subchapter-B/part-111/subpart-E/section-111.70)
- [legislation.gov.uk: Directive 2002/46/EC on Food Supplements (purity criteria)](https://www.legislation.gov.uk/eudr/2002/46/body/2020-12-31/data.xht)
- [EFSA: Re-evaluation of Lecithins (E 322) as a Food Additive (EFSA Journal 2017;15(8):4742)](https://doi.org/10.2903/j.efsa.2017.4742)
- [National Standards of the PRC: QB/T 5821-2023 record (industry standard for phosphatidylserine)](https://std.samr.gov.cn/hb/search/stdHBDetailed?id=099E5E9C51666C69E06397BE0A0ACA38)
