...
- Content goal: Publish one English B2B SEO/GEO/AIO article for ingredient importers, distributors, supplement brands, and formulation or QA teams that need a clear process for reviewing phosphatidylserine allergen and source statements across US and EU projects.
- Topic selection note: This article is intentionally different from today's US contract-manufacturer COA qualification article. That article answers whether a supplier COA is enough under Part 111. This article answers a different dual-market buyer question: what a source-specific allergen statement should show before a soy or sunflower phosphatidylserine route is approved for US and EU use. It also avoids cannibalizing the earlier Europe-only soya labeling and source-change articles by focusing on bulk B2B document control rather than finished-label wording or ingredient substitution.

## SEO Keywords

- Primary Keyword: phosphatidylserine allergen statement
- Secondary Keywords: soy phosphatidylserine allergen statement, sunflower phosphatidylserine source declaration, phosphatidylserine allergen review US EU, phosphatidylserine bulk ingredient allergen statement
- Long-tail Keywords:
  - what should a phosphatidylserine allergen statement include
  - how to review soy phosphatidylserine allergen documents for US and EU buyers
  - does sunflower phosphatidylserine need a soy allergen statement
  - phosphatidylserine source declaration checklist for supplement manufacturers
  - what files should buyers request before approving phosphatidylserine for US and Europe
- AI Overview / GEO Question Targets:
  - What should buyers check on a phosphatidylserine allergen statement?
  - Is soy phosphatidylserine treated differently from sunflower phosphatidylserine for US and EU buyers?
  - Can a COA replace a phosphatidylserine allergen or source statement?
  - What document should importers request before approving phosphatidylserine for dual-market use?
  - How should QA and regulatory teams review source declarations for phosphatidylserine?

## SEO Metadata

- SEO Title: Phosphatidylserine Allergen Statement Checklist for US and EU Buyers
- Meta Description: Learn how to review soy and sunflower phosphatidylserine allergen and source statements for US and EU ingredient approval, artwork routing, and supplier documentation control.
- URL Slug: `/resources/phosphatidylserine-allergen-statement-us-eu/`
- H1: Phosphatidylserine Allergen Statement Checklist for US and EU Ingredient Buyers

## H2/H3 Structure

- H2: The Short Answer Buyers Need First
- H2: Why This Buyer Question Matters Across the US and Europe
  - H3: Soy is a regulated allergen topic in both markets
  - H3: Bulk ingredient approval starts before finished label copy
- H2: The Five-Part Review Workflow
  - H3: Lock the exact phosphatidylserine route before asking for statements
  - H3: Ask for a source declaration and an allergen statement, not one vague email
  - H3: Check the statement against the specification, COA, and product path
  - H3: Keep bulk-label review separate from finished-label approval
  - H3: Record a market-specific go, hold, or escalation decision
- H2: A Mid-Process CTA for Buyers Missing Source-Specific Files
- H2: Common Mistakes in Phosphatidylserine Allergen Review
...
| File point | Soy-route PS review | Sunflower-route PS review | Why it matters |
| --- | --- | --- | --- |
| Product route | Must clearly identify soy-derived path | Must clearly identify sunflower-derived path | Prevents mixed-route approvals |
| Allergen handling | Must be reviewed as a soy-related source topic | Should still be checked as a controlled source statement, not assumed | Keeps QA and artwork aligned |
| Specification match | Product naming and source wording should align | Product naming and source wording should align | Avoids mismatch between quote and file set |
| Bulk-label support | Confirm source wording used in the supply chain | Confirm source wording used in the supply chain | Helps receiving and customer handoff |
| Change control | Escalate if the route changes from prior approval | Escalate if a prior soy file is being replaced | Stops quiet source substitution |
...
If your team is still debating whether a phosphatidylserine route is soy-derived or sunflower-derived, stop the approval flow and request the current source-specific file set before moving further. Nutranexa's [contact page](/contact/) can be used to request the current specification, source declaration, COA support path, packaging references, and route-specific document handling for the exact phosphatidylserine item under review.
...
For buyers evaluating Nutranexa, the current site supports this review in several practical ways. It provides separate product paths for general PS, soy PS, and sunflower PS, which is exactly how a disciplined allergen-review workflow should begin. It also provides visible document-request pathways through [Quality & R&D](/quality-rd/), [Manufacturing](/manufacturing/), and [Contact Sales](/contact/), plus public references to COA and specification support.
...
If a project may shift from soy to sunflower or vice versa, buyers should also keep [Soya Phosphatidylserine Labeling and Regulatory Prep for European Supplement Buyers](/resources/soya-phosphatidylserine-labeling-europe/) and [Can Sunflower Phosphatidylserine Replace Soya Phosphatidylserine in Europe?](/resources/sunflower-phosphatidylserine-europe-source-change/) in view. Those pages address adjacent issues. This article stays focused on the earlier control point: the source-specific statement that should be reviewed before those downstream questions expand.

## Sources

- [FDA: Food Allergies](https://www.fda.gov/food/nutrition-food-labeling-and-critical-foods/food-allergies)
- [FDA Guidance for Industry: Questions and Answers Regarding Food Allergens, Including the Food Allergen Labeling Requirements of the Federal Food, Drug, and Cosmetic Act (Edition 5)](https://www.fda.gov/media/117410/download)
- [Regulation (EU) No 1169/2011 on the provision of food information to consumers](https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=CELEX:02011R1169-20250401)
...
Contact Nutranexa to request current source-specific phosphatidylserine files, including specification support, COA review support, packaging references, and route-specific document handling for soy and sunflower projects serving Europe and North America.
