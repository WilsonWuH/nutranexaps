...
- Date: 2026-08-08
- Published At: 2026-08-08T18:00:00Z
- Audience: US supplement brands, private-label teams, contract manufacturers, distributors, importers, procurement managers, and regulatory or marketing teams that buy bulk phosphatidylserine (PS) and need a defensible answer on which label claims are allowed, which evidence supports them, and where supplier documents end and finished-product claim substantiation begins.
- Content goal: Answer the real buyer question of what structure/function claims can be made for a phosphatidylserine dietary supplement in the United States, how to tell a permitted claim from a disease claim, what substantiation looks like, what the FDA notification and disclaimer duties are, and how an ingredient supplier's documents support - but do not replace - the finished-product claim file.
- Topic selection note: This run is the third article of the 2026-08-08 publishing cycle. The first two cycle articles were `Phosphatidylserine Moisture and Water Activity Specification Review for US and EU Buyers` and `Phosphatidylserine MOSH and MOAH Testing Review for US and EU Buyers`, both analytical-quality and contaminant lanes. This article intentionally moves to a distinct North American regulatory-preparation trigger: US dietary supplement structure/function claim classification, substantiation, notification, and disclaimer control for PS finished products. A grep of the full resource library confirmed no existing article covers structure/function claims, claim substantiation, FDA notification, or disease-claim criteria as its main topic; the Supplement Facts label article covers panel layout, the NDI review covers premarket notification for new dietary ingredients, the GRAS scope article covers conventional-food ingredient status, the health-claims article is Europe-only, and the vegan/kosher/allergen articles cover voluntary statement review. No keyword cannibalization with those pages or with label, import, or testing resources.
- Primary Keyword: phosphatidylserine structure function claim
- Secondary Keywords:
  - PS supplement claims US
  - phosphatidylserine claim substantiation
  - FDA structure function claim notification
  - dietary supplement disease claim criteria
  - PS cognitive support claim labeling
- Long-tail Keywords:
  - what structure function claims can I make for a phosphatidylserine supplement
  - is supports memory a structure function claim or a disease claim
  - what evidence substantiates a phosphatidylserine cognitive support claim
  - do I need to notify FDA of a phosphatidylserine structure function claim
  - what is the FDA disclaimer for dietary supplement structure function claims
  - what documents should a PS ingredient buyer request before claim development
- AI Overview / GEO Question Targets:
  - What are structure/function claims for dietary supplements?
  - Is "supports memory" a structure/function claim or a disease claim for a PS supplement?
  - What substantiation does FDA expect for a phosphatidylserine structure/function claim?
  - Do supplement brands need to notify FDA when they use a structure/function claim?
  - What disclaimer must appear with a dietary supplement structure/function claim?
  - How is supplier evidence different from finished-product claim substantiation for PS?
- Search Intent: High-intent US label and claims preparation before supplement product launch, artwork approval, and marketing handoff
- Funnel Stage: Finished-product commercialization, label and claims review, supplier document request, and brand-owner decision making
- SEO Title: Phosphatidylserine Structure/Function Claims for US Brands | Nutranexa
- Meta Description: Review US structure/function claims for phosphatidylserine supplements: permitted wording, disease-claim boundaries, substantiation, FDA notification, and disclaimer control.
- URL Slug: /resources/phosphatidylserine-structure-function-claims-us/
- H1: Phosphatidylserine Structure/Function Claims: A US Supplement Buyer's Review

## Introduction

Most US supplement brands meet structure/function claims during label development, when marketing asks what a [phosphatidylserine](/products/phosphatidylserine/) (PS) product may say about memory, focus, or cognitive function. **The direct answer: a US dietary supplement may carry a structure/function claim such as "supports memory" only if the brand holds substantiation that the claim is truthful and not misleading, notifies FDA within 30 days of first marketing, and displays the mandatory disclaimer; claims that diagnose, treat, cure, or prevent a disease are not allowed on a supplement label.** Supplier documents such as specifications and certificates of analysis support ingredient identity and quality, but they do not by themselves substantiate a finished-product claim.
...
1. **Substantiation.** The firm has substantiation that the claim is truthful and not misleading before the claim is used.
2. **Notification.** FDA receives a notification with the claim text no later than 30 days after the product is first marketed with the claim.
3. **Disclaimer.** The claim appears with the exact disclaimer, prominently displayed and in boldface type.
...
1. Does the claim name or imply a specific disease or class of diseases?
2. Does the claim reference signs or symptoms that are characteristic of a disease?
3. Does the product name, imagery, or packaging context imply a disease use?
4. Would a reasonable consumer read the claim as treatment or prevention?
5. If the claim has more than one reasonable meaning, is there substantiation for each meaning?
...
| --- | --- | --- |
| Specification sheet | Identity, PS content, source, and quality parameters for the quoted product | Substantiate a specific cognitive benefit |
...
Nutranexa's public materials support the document side of this picture: the company publishes specification and COA evidence paths, describes manufacturing and quality-control activity, and offers a [Quality & R&D](/quality-rd/) page and a [document request path](/contact/) for current files. What Nutranexa does not do is publish finished-product health or disease claims for brands to copy; the claim file is built by the brand, usually with regulatory counsel, from evidence that relates to the finished product.
...
1. Lock the exact product: source (soy or sunflower PS), PS content, serving size, and formulation.
2. Review the supplier's specification, COA, and quality documents for the quoted lot.
3. Draft claim wording, then screen each statement with the five-question disease-claim test.
4. Collect the substantiation file: studies and data that relate to the finished product, dose, population, and claim wording.
5. Prepare the FDA notification with the exact claim text and sign-off.
6. Place the disclaimer next to or linked to each claim, in boldface, at the required size.
7. Extend the review to every marketing channel before launch.

For teams that have not yet selected a PS source, the source decision affects the document set: [soy PS](/products/soy-phosphatidylserine/) and [sunflower PS](/products/sunflower-phosphatidylserine/) have separate specification and COA evidence paths, and the [supplier COA qualification review](/resources/phosphatidylserine-supplier-coa-qualification-us/) explains how US contract manufacturers decide what incoming evidence is required. The [NDI review](/resources/phosphatidylserine-ndi-review-us/) covers the separate question of whether a new dietary ingredient notification is needed before marketing, and the [Supplement Facts label review](/resources/phosphatidylserine-supplement-facts-label-us/) covers the panel itself.

Need current PS specifications, COA samples, source documentation, and manufacturing evidence for your claim file? [Request the specification and document evidence](/contact/) with your target assay, source preference, application, and destination market.
...
- [FDA: Structure/Function Claims (dietary supplements)](https://www.fda.gov/food/nutrition-food-labeling-and-critical-foods/structurefunction-claims)
- [FDA: Guidance for Industry - Substantiation for Dietary Supplement Claims Made Under Section 403(r)(6) of the FD&C Act (January 2009)](https://www.fda.gov/regulatory-information/search-fda-guidance-documents/guidance-industry-substantiation-dietary-supplement-claims-made-under-section-403r-6-federal-food)
- [FDA: Small Entity Compliance Guide on Structure/Function Claims (January 2002)](https://www.fda.gov/regulatory-information/search-fda-guidance-documents/small-entity-compliance-guide-structurefunction-claims)
- [eCFR: 21 CFR 101.93 - Certain types of statements for dietary supplements](https://www.ecfr.gov/current/title-21/chapter-I/subchapter-B/part-101/subpart-B/section-101.93)
...
- [FDA: Notifications of Structure/Function and Related Claims](https://www.fda.gov/food/information-industry-dietary-supplements/notifications-structurefunction-and-related-claims-dietary-supplement-labeling)
