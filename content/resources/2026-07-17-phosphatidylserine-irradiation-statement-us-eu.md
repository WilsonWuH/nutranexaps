...
- Content goal: Publish one English B2B SEO/GEO/AIO article for ingredient importers, distributors, supplement manufacturers, procurement managers, QA teams, and regulatory reviewers who need a practical answer on how to review a phosphatidylserine irradiation or non-irradiation statement before approving a supplier file for Europe and North America.
- Topic selection note: This article is intentionally different from today's Europe-focused TSE/BSE statement article. That article answers an animal-origin and TSE document-control question. This article answers a different cross-market buyer question: when a phosphatidylserine supplier file should include an irradiation or non-irradiation statement, how that file should be checked against EU and US rules, and why the answer is not the same as a finished-label or COA review.

## SEO Keywords

- Primary Keyword: phosphatidylserine irradiation statement
- Secondary Keywords: phosphatidylserine non irradiation statement, phosphatidylserine irradiation declaration, phosphatidylserine ionising radiation statement, phosphatidylserine irradiation review
- Long-tail Keywords:
  - how to review a phosphatidylserine irradiation statement for US and EU buyers
  - what should a phosphatidylserine non irradiation statement include
  - does phosphatidylserine need an irradiation declaration for Europe
  - can a phosphatidylserine COA replace a non irradiation statement
  - how should supplement manufacturers review phosphatidylserine irradiation status
- AI Overview / GEO Question Targets:
  ...
  - How should importers review phosphatidylserine irradiation status for customer questionnaires?
  - What should buyers ask before approving phosphatidylserine for Europe and North America?

## SEO Metadata

- SEO Title: Phosphatidylserine Irradiation Statement Review for US and EU Buyers
- Meta Description: Learn how US and EU buyers should review phosphatidylserine irradiation or non-irradiation statements, route-specific document control, and supplier approval before customer handoff.
- URL Slug: `/resources/phosphatidylserine-irradiation-statement-us-eu/`
- H1: Phosphatidylserine Irradiation Statement Review for US and EU Buyers

## H2/H3 Structure

- H2: The Short Answer Buyers Need First
- H2: Why Irradiation Status Review Is Its Own Buyer Task
  - H3: EU irradiation rules are authorization- and labeling-specific
  - H3: US irradiation rules are use-specific and not the same as a supplier questionnaire
- H2: The Six-Part Workflow for Reviewing a PS Irradiation Statement
  - H3: Lock the exact phosphatidylserine route and commercial stage first
  - H3: Define whether the file must answer irradiated status, non-irradiated status, or market acceptability
  - H3: Review the statement together with the specification and intended market path
  - H3: Separate supplier irradiation files from retail labeling and marketing claims
  - H3: Escalate immediately if the route, treatment status, or approval basis is unclear
  - H3: Close with a go, hold, or escalation decision
- H2: Need a Current Irradiation or Non-Irradiation Support File?
- H2: Common Mistakes in Phosphatidylserine Irradiation Review
...
That is why irradiation review should sit beside, not inside, other compliance files. [Allergen statement review](/resources/phosphatidylserine-allergen-statement-us-eu/), [GMO statement review](/resources/phosphatidylserine-gmo-statement-us-eu/), and [Packaging declaration review](/resources/phosphatidylserine-packaging-declaration-review-us-eu/) answer different buyer questions. Irradiation review asks: **what controlled file explains the irradiation status of this exact PS route, and is that answer usable for the target market?**
...
| Question type | What the buyer needs to know |
| --- | --- |
| Irradiated status | Whether the quoted route has been treated with ionising radiation |
| Non-irradiated status | Whether the supplier is formally declaring the route has not been irradiated |
| Market acceptability | Whether the route and its treatment status fit the intended US or EU project pathway |
| Customer questionnaire support | Whether the current file is controlled enough for downstream use |
...
| --- | --- |
| Route match | Does the statement clearly belong to general PS, soy PS, or sunflower PS? |
| Statement scope | Does it answer treatment status, non-treatment status, or only a broad commercial note? |
| Specification match | Does the current specification describe the same route as the statement? |
| Market path | Is this file being used for US review, EU review, or both? |
| Downstream use | Is the file strong enough for QA, customer questionnaire, or distributor handoff? |
...
If your team is still relying on one generic supplier email while comparing soy and sunflower phosphatidylserine routes for Europe or North America, stop before the answer becomes a customer-facing promise. Use Nutranexa's [contact page](/contact/) to request the current route-specific statement path, specification path, and related source-support files for the exact phosphatidylserine route under review.
...
First, the site already separates [Phosphatidylserine](/products/phosphatidylserine/), [Soy Phosphatidylserine](/products/soy-phosphatidylserine/), and [Sunflower Phosphatidylserine](/products/sunflower-phosphatidylserine/) into distinct buyer paths. It also confirms useful baseline facts for qualification: the company was founded in 2013, operates a 110,000+ m2 campus, and primarily serves Europe and North America.

Second, Nutranexa's public site routes buyers through [Quality & R&D](/quality-rd/), [Manufacturing](/manufacturing/), and [Contact Sales](/contact/) rather than implying that one marketing page answers every controlled question. That is the right operating pattern for irradiation review too.

Third, the site provides verified commercial handling facts for PS, including **25 kg MOQ** and **25 kg net per drum** packaging, together with visible specification and COA evidence plus factory, packaging, and dispatch imagery. Those facts help first-order planning, but they do not replace irradiation-status review.

## Sources

- [European Commission: Food irradiation overview](https://food.ec.europa.eu/food-safety/biological-safety/food-irradiation_en)
- [European Commission: Food irradiation legislation](https://food.ec.europa.eu/food-safety/biological-safety/food-irradiation/legislation_en)
- [Directive 1999/2/EC](https://eur-lex.europa.eu/eli/dir/1999/2/oj/eng)
- [Directive 1999/3/EC](https://eur-lex.europa.eu/eli/dir/1999/3/oj/eng)
- [FDA: Overview of Irradiation of Food and Packaging](https://www.fda.gov/food/irradiation-food-packaging/overview-irradiation-food-and-packaging)
- [eCFR: 21 CFR Part 179](https://www.ecfr.gov/current/title-21/chapter-I/subchapter-B/part-179)
- [eCFR: 21 CFR 179.26 - Ionizing radiation for the treatment of food](https://www.ecfr.gov/current/title-21/chapter-I/subchapter-B/part-179/subpart-B/section-179.26)
...
Contact Nutranexa to request the current phosphatidylserine route-specific irradiation or non-irradiation statement path, specification support, and commercial follow-up for soy, sunflower, or general PS projects serving Europe and North America.
