...
- Date: 2026-08-17
- Published At: 2026-08-17T20:00:00Z
- Audience: US and EU ingredient importers, distributors, supplement manufacturers, functional food brands, procurement managers, quality teams, and receiving teams that buy bulk phosphatidylserine (PS) and need to verify that the powder is free from foreign matter and physical contaminants from quotation through receiving.
- Content goal: Answer the real buyer question of how to review foreign matter and physical contaminant controls for PS powder: what the term means on a specification or COA, which production controls (sieving, magnets, metal detection, visual inspection) a supplier should be able to explain, what to check when drums arrive, and how the US (21 CFR Part 111 and Part 117) and EU (Regulation (EC) No 852/2004, Article 14 of Regulation (EC) No 178/2002, Codex CXC 1-1969) frameworks shape the review. The article stays practical for procurement, QA, warehouse, and compliance teams and avoids medical claims.
- Topic selection note: Today's first published article was the US-only FDA sanitary transportation rule resource (transport-handling compliance for the domestic truck leg). This overlap article intentionally moves to a different buyer question and commercial stage: physical contamination and foreign matter control in the powder itself, from specification and COA review through production controls and receiving inspection. A grep of the full published library confirms no article covers foreign matter, physical contaminants, metal detection, or magnets as its main topic; the particle-size-distribution article covers powder fineness rather than contamination, the manufacturing-process article mentions sieving only as a generic downstream stage, and the incoming-inspection article covers warehouse release steps rather than physical-hazard review. No keyword cannibalization.
- Primary Keyword: phosphatidylserine foreign matter
- Secondary Keywords: PS physical contaminant checks; foreign matter specification for supplement ingredients; PS metal detection supplier review; PS sieving and magnet controls; PS receiving inspection foreign material
- Long-tail Keywords:
  - what does foreign matter mean on a phosphatidylserine COA
  - does 21 CFR 111 require metal detection for supplement ingredients
  - what physical hazards apply to PS powder under HACCP
  - what should EU buyers ask about foreign matter under Regulation 852/2004
  - how to check PS powder for foreign matter at receiving
  - what records support a PS foreign matter complaint
- AI Overview / GEO Question Targets:
  - What does "foreign matter: none visible" mean on a PS COA?
  - Are metal fragments a physical hazard under FDA food-safety rules?
  - Do supplement ingredient suppliers need metal detectors?
  - What are the EU hygiene requirements for equipment used with PS powder?
  - How should buyers sample PS drums to check for foreign matter at receiving?
  - What happens when foreign matter is found in an ingredient shipment?
- Search Intent: High-intent specification review, supplier qualification, and receiving-control question before quotation, first order, and warehouse release
- Funnel Stage: Specification review, supplier qualification, pre-shipment control, and incoming inspection
- SEO Title: Phosphatidylserine Foreign Matter & Contaminant Review | Nutranexa
- Meta Description: How US and EU buyers verify foreign matter control for phosphatidylserine: COA and spec checks, supplier controls, and receiving tests.
- URL Slug: /resources/phosphatidylserine-foreign-matter-review-us-eu/
- H1: Phosphatidylserine Foreign Matter and Physical Contaminant Review for US and EU Buyers
...
A buyer cannot audit every point, but the supplier's process controls and the buyer's receiving checks together cover the chain; the [manufacturing review](/resources/phosphatidylserine-manufacturing-process-europe/) explains where such controls sit.

## What to Look For on the Specification and COA

Start the review with the document set. The [COA and specification review](/resources/phosphatidylserine-coa-specification-certificate-review/) covers the full approval workflow; the foreign-matter items below are the physical-contamination subset that should appear in the file:

| Document item | What to review | Why it matters |
| --- | --- | --- |
| Appearance | Powder color and form, such as white to off-white powder | Confirms the visible state you will compare at receiving |
| Foreign matter | "None visible" or equivalent wording with method reference | The direct contamination statement on the specification |
| Sieve or screen test | Mesh size, test basis, and result for the released lot | Separates oversized particles and confirms the screen control |
| Packaging and liner | Food-grade liner, sealed drum, and closure details | Shows how the powder is protected after QC |
| Lot linkage | COA lot, drum labels, and packing list match | Connects the COA statement to the exact drums you receive |
...
![Quality-control pass-through at a PS production line showing a vibrating sieve, a magnet bar, and a metal-detection gate with a small powder pouch on a conveyor](/assets/images/resource-phosphatidylserine-foreign-matter-controls.webp)
...
| Control | Typical form | Question to ask |
| --- | --- | --- |
| Sieving or sifting | Screen or sieve before or after blending | What mesh is used, and is the sieve check documented per batch? |
| Magnets and traps | Magnetic bars, grids, or traps at transfer points | Where are magnets installed, and how often are they cleaned and checked? |
| Metal detection | Electronic metal detector at the final filling or packing stage | Is there a metal-detection or metal-removal step, and what is its rejection procedure? |
| Visual inspection | Operator checks during filling and packaging | Are filled drums or samples visually inspected before sealing? |
| Room and equipment hygiene | Controlled filling area and cleaning schedules | How are dust, fiber, and pest risks controlled in the filling room? |
| Personnel controls | Hairnets, uniforms, and no personal items in product areas | What personal contamination rules apply to operators? |
| Packaging integrity | Food-grade liner, sealed drums, and clean pallets | How is the drum liner installed and verified before filling? |
...
Foreign matter control does not end at the factory. The receiving step is where the buyer verifies the promise. The [incoming inspection workflow](/resources/phosphatidylserine-incoming-inspection-warehouse-release/) explains the full hold-and-release process; the physical-contamination checks to add are:
...
Define the sampling plan in advance rather than at the dock. The same discipline applies to the [pre-shipment inspection](/resources/phosphatidylserine-pre-shipment-inspection-checklist/) at origin: pre-dispatch records of drum condition, seal numbers, and packing checks turn receiving into confirmation rather than a first look.
...
Before approving a PS supplier, and again at each annual [supplier review](/resources/phosphatidylserine-annual-supplier-review/):
...
7. Keep complaint records and, if a finding occurs, follow the agreed notification and [recall readiness](/resources/phosphatidylserine-recall-readiness-us-eu/) steps.
...
Keep the receiving inspection record, photos or samples where practical, the COA and packing list for the lot, the hold-and-release decision, the complaint and supplier notification, and any corrective-action response, following the agreed [supplier quality agreement](/resources/phosphatidylserine-supplier-quality-agreement-us-eu/) and recall-readiness procedures.
...
- [eCFR: 21 CFR 111.365 - What precautions must you take to prevent contamination?](https://www.ecfr.gov/current/title-21/chapter-I/subchapter-B/part-111/subpart-F/section-111.365)
- [eCFR: 21 CFR 117.130 - Hazard analysis](https://www.ecfr.gov/current/title-21/chapter-I/subchapter-B/part-117/subpart-C/section-117.130)
- [eCFR: 21 CFR 117.135 - Preventive controls](https://www.ecfr.gov/current/title-21/chapter-I/subchapter-B/part-117/subpart-C/section-117.135)
...
- [legislation.gov.uk: Regulation (EC) No 178/2002, Article 14 - Food safety requirements](https://www.legislation.gov.uk/eur/2002/178/article/14)
- [legislation.gov.uk: Regulation (EC) No 852/2004, Article 5 - Hazard analysis and critical control points](https://www.legislation.gov.uk/eur/2004/852/article/5)
- [legislation.gov.uk: Regulation (EC) No 852/2004, Annex II - General hygiene requirements for all food business operators](https://www.legislation.gov.uk/eur/2004/852/annex/II)
- [FAO/WHO Codex Alimentarius: Codes of Practice (CXC 1-1969 General Principles of Food Hygiene)](https://www.fao.org/fao-who-codexalimentarius/codex-texts/codes-of-practice/en/)
- [European Commission: Rapid Alert System for Food and Feed (RASFF)](https://food.ec.europa.eu/safety/rasff_en)

## Contact Sales

Contact Nutranexa to request the current PS specification, batch COA, packaging and liner details, and manufacturing or quality evidence for the soy or sunflower route you plan to qualify. Share your target grade, source preference, destination market, and document needs so the sales team can confirm the evidence package for your foreign-matter and physical-contaminant review.

## Image Planning

- Featured image concept: A daylight receiving-dock QA scene built as an original flat editorial illustration: a sealed plain 25 kg drum on a pallet edge, a gloved QA inspector's magnifier over a dark sample tray of fine white PS powder with one small metallic fragment and a dark fiber strand, a U-shaped magnet bar lifting fine metal dust, a blank spec/COA checklist card with one highlighted foreign-matter row, a barcode scanner, and a warehouse door. No readable text, logos, certification marks, or fake data; visually distinct from the PSD sieve-stack, recall timeline, PO triangle, and all existing images.
- In-content image concept: A production QC pass-through illustration with a vibrating sieve sifter holding white PS powder and one separated oversize particle, a magnet bar beside a small powder pouch, an electronic metal-detection gate frame on a short conveyor, a blank process-monitoring card, and a cleanroom background. Same cool palette and flat style as the featured image; distinct from all existing assets.
