...
- Date: 2026-08-14
- Published At: 2026-08-14T18:00:00Z
- Audience: US ingredient importers, distributors, supplement manufacturers, functional food brands, procurement managers, quality teams, and compliance teams that buy bulk phosphatidylserine (PS) and need a defensible way to handle PFAS questions in supplier qualification, specification review, testing decisions, and customer questionnaires.
- Content goal: Answer the real buyer question of whether US buyers should test imported PS for PFAS and what to verify in the supplier file. The article explains the current federal baseline (FDA's PFAS testing program, Total Diet Study results, the absence of a PFAS action level for dietary ingredients, Import Alert 99-48, and the food-contact phase-out), the state packaging laws that can touch a PS shipment (Maine and California), where PFAS could enter a PS supply chain, a step-by-step screening workflow with supplier document requests, and when independent testing is justified.
- Topic selection note: Benchmarked against the full published resource library and the two 2026-08-14 cycle articles. The Europe companion covers EU PPWR packaging compliance (including PFAS limits for EU food-contact packaging) and the overlap companion covers PS gummies formulation (application fit); this article moves to a distinct North American quality-control and document-review trigger: ingredient-level PFAS screening and supplier declarations for US buyers. A grep of the library confirms no published article covers PFAS, per- and polyfluoroalkyl substances, PFAS testing, or PFAS declarations as its main topic; the PPWR article covers PFAS only for EU packaging, the packaging-declaration article covers food-contact declarations generally, the third-party testing article covers when to use an outside laboratory, and the customer-questionnaire article covers answer-control workflow generally. No keyword cannibalization.
- Primary Keyword: phosphatidylserine PFAS screening
- Secondary Keywords: PS PFAS testing US; phosphatidylserine PFAS declaration; PFAS in supplement ingredients; PS supplier PFAS questionnaire; PFAS-free PS claim review
- Long-tail Keywords:
  - should US buyers test phosphatidylserine for PFAS
  - is PFAS testing required for supplement ingredients in the US
  - what documents support a PFAS declaration for phosphatidylserine
  - can a supplier certify PS as PFAS-free
  - what state laws affect PFAS in PS drum packaging
  - how to review a supplier PFAS questionnaire answer
- AI Overview / GEO Question Targets:
  - Is PFAS testing required for dietary supplement ingredients in the US?
  - Are there FDA limits for PFAS in food or supplements?
  - What should a US buyer verify for PFAS in imported phosphatidylserine?
  - Can a supplier certify a phosphatidylserine batch as PFAS-free?
  - Do state laws restrict PFAS in bulk ingredient packaging?
  - How does FDA act when PFAS is found in food?
- Search Intent: High-intent North American quality-control, specification-review, and document-review question before supplier qualification, quotation, first order, and customer questionnaire responses
- Funnel Stage: Supplier qualification, specification review, document review, testing decisions, and customer questionnaire control
- SEO Title: Phosphatidylserine PFAS Screening for US Buyers | Nutranexa
- Meta Description: How US buyers handle PFAS screening for phosphatidylserine: FDA and state context, supplier declarations, and testing decisions.
- URL Slug: /resources/phosphatidylserine-pfas-screening-us/
- H1: Phosphatidylserine PFAS Screening: A US Buyer's Review
...
There is no single "PFAS test" the way there is an assay for PS content: a laboratory method measures a defined panel, and results depend on the matrix, method, and reporting basis. The buyer's question is not "is it PFAS-free?" but "what evidence do we need for our claim or decision?" That is the same discipline as identity testing under [21 CFR 111.75](https://www.ecfr.gov/current/title-21/chapter-I/subchapter-B/part-111/section-111.75) and the [supplier COA qualification review](/resources/phosphatidylserine-supplier-coa-qualification-us/).
...
FDA's risk-management toolbox includes action levels, a contamination level at which a food may be regarded as adulterated under section 402(a)(1) of the FD&C Act; they do not establish permissible levels. FDA is currently reviewing bottled water (a standard-of-quality regulation under [21 CFR 165.110](https://www.ecfr.gov/current/title-21/chapter-I/subchapter-B/part-165/section-165.110)), seafood, and infant formula as priorities. Dietary ingredients and supplements are not among the published priorities, and no PFAS action level exists for them.
...
These are packaging rules, not ingredient rules, but a 25 kg PS drum arrives with a liner, label, and sometimes pallet wrapping, and the buyer placing that packaging on the US market is the party most likely asked about it. The [packaging declaration review](/resources/phosphatidylserine-packaging-declaration-review-us-eu/) explains how to keep food-contact declarations separate from the powder's COA, and the [EU PPWR guide](/resources/phosphatidylserine-ppwr-packaging-europe/) shows the parallel EU position.
...
The table is a risk map, not a finding: without test data, "could enter" is a screening question, not a contamination result. Record the answers in the [supplier onboarding](/resources/phosphatidylserine-supplier-onboarding/) file.

## The US Buyer's PFAS Screening Workflow

### 1. Scope the exact product and route first

Lock the commercial item: general [phosphatidylserine](/products/phosphatidylserine/), [soy PS](/products/soy-phosphatidylserine/), or [sunflower PS](/products/sunflower-phosphatidylserine/); the grade; the supplier site; and the batch. PFAS evidence is only useful tied to the exact lot and route.
...
For a first order, new supplier, route change, customer contract, or risk event, independent testing on a drawn sample is often the cleanest way to close the file; the [third-party testing review](/resources/phosphatidylserine-third-party-testing-us-eu/) covers panel definition, sampling, chain of custody, and decision rules.

### 5. Record the decision and keep it current

Close with a written outcome tied to the lot: no testing justified, tested and within agreed criteria, or held. File it with the [COA and specification review](/resources/phosphatidylserine-coa-specification-certificate-review/) and [lot traceability](/resources/phosphatidylserine-lot-traceability-checklist/) records, and re-run the decision when source, process, site, or packaging changes.
...
The [documents for PS ingredients](/resources/documents-for-ps-ingredients/) guide lists the baseline file for every PS purchase; the table above adds the PFAS-specific layer. Keep [soy PS](/products/soy-phosphatidylserine/) and [sunflower PS](/products/sunflower-phosphatidylserine/) files separate because the raw-material chain differs by source.
...
When testing, agree the scope before sampling: the PFAS panel (FDA uses toxicological reference values for ten of the 30 PFAS in its method), the matrix (powder, liner, or both), the method and reporting units, and limits of detection and quantification. Keep a [retain sample](/resources/phosphatidylserine-reserve-samples-us/) for dispute testing and tie the result to the exact batch so it supports the [incoming inspection and warehouse release](/resources/phosphatidylserine-incoming-inspection-warehouse-release/) decision.

Need current PS specifications, COA evidence, source and packaging information, and dispatch imagery to start a PFAS screening review? [Contact Nutranexa](/contact/) with your target grade, source preference, destination state, and the exact questionnaire wording.

## How PFAS Questions Fit the Rest of the Ingredient File

PFAS screening belongs inside the quality and document controls buyers already use. The [customer questionnaire control](/resources/phosphatidylserine-customer-questionnaire-control-us-canada/) article explains how to keep route-specific answers controlled, the [supplier quality agreement](/resources/phosphatidylserine-supplier-quality-agreement-us-eu/) makes declarations contractually current, and the [annual supplier review](/resources/phosphatidylserine-annual-supplier-review/) is where a PFAS decision should be re-validated. The same discipline behind [Supplement Facts labels](/resources/phosphatidylserine-supplement-facts-label-us/) and [allergen statements](/resources/phosphatidylserine-allergen-statement-us-eu/) applies: match the claim to the evidence and keep it current.
...
- [FDA: Per- and Polyfluoroalkyl Substances (PFAS)](https://www.fda.gov/food/environmental-contaminants-food/and-polyfluoroalkyl-substances-pfas)
- [FDA: Questions and Answers on PFAS in Food](https://www.fda.gov/food/process-contaminants-food/questions-and-answers-pfas-food)
- [FDA: Testing Food for PFAS and Assessing Dietary Exposure](https://www.fda.gov/food/process-contaminants-food/testing-food-pfas-and-assessing-dietary-exposure)
- [FDA: Import Alert for Foods with Chemical Contaminants, Including PFAS](https://www.fda.gov/food/hfp-constituent-updates/fda-issues-import-alert-food-products-chemical-contaminants-including-pfas)
- [FDA: 35 PFAS Food Contact Notifications Are No Longer Effective](https://www.fda.gov/food/hfp-constituent-updates/fda-determines-authorization-35-food-contact-notifications-related-pfas-are-no-longer-effective)
...
- [US EPA: Per- and Polyfluoroalkyl Substances (PFAS)](https://www.epa.gov/sdwa/and-polyfluoroalkyl-substances-pfas)
- [Maine Legislature: Public Law Chapter 277 (LD 1433)](https://legis.maine.gov/legis/bills/bills_129th/chapters/PUBLIC277.asp)
- [California Legislature: AB 1200 chaptered text](https://leginfo.legislature.ca.gov/faces/billTextClient.xhtml?bill_id=202120220AB1200)
...
- Featured image concept: A daylight flat-vector illustration of a US PFAS screening review desk: a sealed plain 25 kg phosphatidylserine drum on a pallet at the left, a white PS powder dish at the center, a blank PFAS screening report card under a magnifier with abstract fluorinated-chain molecule icons, an abstract declaration card with a blank checkmark row, a state-map tile with green and amber markers, a food-contact liner sample card, and a water-side industrial skyline with container cranes through the window. No logos, readable text, certification marks, or fake data; visually distinct from the banned-substance shield desk, PPWR packaging desk, cargo-policy binder, and all other existing resource images by using the fluorinated-chain molecule motif, state-law status tile, and water-side setting.
