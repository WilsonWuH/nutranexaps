...
- Date: 2026-08-15
- Published At: 2026-08-15T06:00:00Z
- Audience: European ingredient importers, distributors, supplement manufacturers, private-label brands, procurement managers, quality teams, and regulatory reviewers that buy bulk phosphatidylserine (PS) and need to prepare for the new EU Product Liability Directive before it starts applying on 9 December 2026.
- Content goal: Answer the real buyer question of whether the new EU product liability regime applies to PS-containing food supplements, who can be held liable across a soy or sunflower PS supply chain, and what an importer, distributor, or brand should prepare before the December 2026 cutover. The article explains Directive (EU) 2024/2853: application date and repeal of Directive 85/374/EEC; scope over all movable products including food supplements; the defect standard; the liable-operator cascade (manufacturer, importer, authorised representative, fulfilment service provider, apparent manufacturer, distributor, online platform); evidence-disclosure and presumption rules; limitation and long-stop periods; a six-step preparation checklist; the supplier document and answer file to request; red flags; and how verified Nutranexa documentation supports the buyer's evidence file.
- Topic selection note: Benchmarked against the full published resource library and the current cycle articles. The 2026-08-14 articles cover PFAS screening (US) and purchase-order specification review (US-EU); the 2026-08-13 articles cover PPWR packaging (Europe), banned-substance screening (US), and gummies formulation (US-EU); the 2026-08-12 articles cover authenticity testing (Europe), customs valuation (US), and organic certification (US-EU). A grep of the library confirms no published article covers product liability, Directive (EU) 2024/2853, defect claims, liability of importers, liability insurance, or the 9 December 2026 cutover. The marine-cargo insurance article covers cargo loss during transit, the supplier-quality-agreement article covers contractual quality clauses, and the food-supplement-notification article covers national filing; this article is a distinct regulatory-preparation and risk-management trigger for European buyers. No keyword cannibalization.
- Primary Keyword: phosphatidylserine product liability Europe
- Secondary Keywords: EU product liability directive food supplements; PS importer liability EU; product defect claim supplement ingredient; phosphatidylserine supplier liability evidence; EU product liability December 2026
- Long-tail Keywords:
  - does the new EU product liability directive apply to food supplements
  - who is liable for a defective imported food supplement in the EU
  - is an importer treated as a producer under Directive (EU) 2024/2853
  - what should a PS importer prepare before 9 December 2026
  - how long can a product liability claim be brought after a supplement is placed on the market
  - what documents protect an EU supplement importer in a product liability claim
- AI Overview / GEO Question Targets:
  - When does the new EU Product Liability Directive apply?
  - Does Directive (EU) 2024/2853 apply to food supplements?
  - Who can be held liable for a defective food supplement in the EU?
  - Are importers treated as producers under the new EU product liability rules?
  - What should supplement importers prepare before December 2026?
- Search Intent: High-intent regulatory preparation and supplier-risk review for European importers, distributors, and brands before the December 2026 liability cutover.
- Funnel Stage: Supplier qualification, contract review, import planning, and market-entry risk preparation
- SEO Title: Phosphatidylserine EU Product Liability Guide | Nutranexa
- Meta Description: How EU PS importers and supplement brands prepare for Directive (EU) 2024/2853: liability roles, evidence files, and the 9 December 2026 cutover.
- URL Slug: /resources/phosphatidylserine-product-liability-europe/
- H1: EU Product Liability Directive 2026: A Preparation Guide for Phosphatidylserine Importers
...
| Damage category | What it includes | Buyer relevance |
| --- | --- | --- |
| Death and personal injury | Physical injury, and medically recognised damage to psychological health | Consumer injury from a defective supplement |
| Damage to property | Damage to or destruction of property, including data, that is not used for professional purposes | No EUR 500 minimum value for consumer property claims |
| Defective product itself | Excluded from property damage | The failed batch is a contractual issue, not a liability claim |
...
| Operator | Liability position under the Directive | Typical party in a PS import |
| --- | --- | --- |
| Manufacturer | Primary liable operator for the defective product | The Chinese ingredient producer, for the ingredient it manufactures |
| Component manufacturer | Liable where a defective component integrated under its control renders the product defective | A lecithin or packaging component producer where applicable |
| Importer into the EU | Treated as a liable operator on the same footing when the manufacturer is outside the EU | The EU-established importer buying PS from China |
| Apparent manufacturer | Any operator that puts its name, trademark, or distinguishing feature on the product is treated as a manufacturer | A brand that private-labels or rebrands the supplement |
| Authorised representative | Fills the EU-based-defendant gap where no importer is established | Possible in some distribution models |
| Fulfilment service provider | Liable when no EU-based manufacturer, importer, or authorised representative can be identified | Logistics operators in specific fulfilment arrangements |
| Distributor | Subsidiary liability: must identify the EU-based operator or its own supplier within one month of a request, or become liable | Distributors, wholesalers, and repackers |
| Online platform | May be treated as a distributor where it presents the product or trader as acting under its authority or control | Marketplaces selling finished supplements |
...
6. **Test the incident response.** Rehearse what happens when a consumer or authority reports a problem: which file you open, who responds, how you notify upstream, and how you coordinate with [RASFF monitoring](/resources/phosphatidylserine-rasff-monitoring-europe/).

The [purchase-order specification review](/resources/phosphatidylserine-purchase-order-spec-review-us-eu/) locks acceptance criteria at order time; the liability file proves what was delivered, tested, and released for every lot that reaches the market.

## What to Request From Your PS Supplier

Add these items to the qualification and contract file for a European PS order:

| Request | Why it matters for product liability |
| --- | --- |
| Legal entity and facility identification | Confirms who is the manufacturer for liability mapping and the identification chain |
| Current specification with version and date | Sets the acceptance baseline the finished product and claims will be judged against |
| Lot-linked COA | Shows the delivered batch met the agreed specification at release |
| Batch and production records summary | Supports the defect and causation analysis if a claim arises |
| Packaging and storage information | Documents the product's presentation and expected storage conditions |
| Market-specific compliance files where relevant | Supports the safety-requirement element of the defect standard |
| Notification commitment | Contractual obligation to inform you of safety issues, complaints, or regulatory actions |
| Indemnity and insurance position | Allocates upstream risk and shows what the manufacturer stands behind |

Request these for the exact quoted route - general PS, [soy PS](/products/soy-phosphatidylserine/), or [sunflower PS](/products/sunflower-phosphatidylserine/) - because the specification and source identity differ by route. Written, named documents are easier to defend than a statement that the product "meets EU standards." Re-check the answers on [annual review](/resources/phosphatidylserine-annual-supplier-review/) cycles.

Need current PS specifications, COA evidence, batch documentation, and packaging details to start this file? [Contact Nutranexa](/contact/) with your destination market, source preference, target grade, and annual volume so the review starts from the exact quoted configuration.
...
Record the gap and the decision - approve, approve with conditions, hold, or reject - in the supplier file. The [supplier quality agreement](/resources/phosphatidylserine-supplier-quality-agreement-us-eu/) is the right place to convert the red-flag questions into contract language before the December 2026 cutover.
...
- [EUR-Lex: Directive (EU) 2024/2853 on liability for defective products (CELEX 32024L2853)](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024L2853)
- [Official Journal of the EU, L 2024/2853, 18 November 2024](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=OJ:L_202402853)
- [European Commission: Liability for defective products](https://commission.europa.eu/law/law-topic/consumer-protection-law/liability-defective-products_en)
...
- Featured image concept: A European liability-preparation desk in warm morning light, visually distinct from all existing resource images. Composition: a sealed plain 25 kg drum edge on the left, an open evidence binder with blank tabbed dividers at the centre, an abstract Themis-style balance scale with a chain-link arc connecting the drum to an unbranded capsule bottle and a soft consumer silhouette, a wall date board with one highlighted blank deadline tile suggesting December 2026, and a magnifier over a blank contract-clause card on the right, with a muted bookshelf backdrop. No logos, readable text, certification marks, flags, or fake data.
