...
- Date: 2026-08-05
- Published At: 2026-08-05T22:00:00Z
- Audience: Overseas ingredient importers, distributors, supplement manufacturers, functional food brands, procurement managers, formulation teams, and quality teams in Europe and North America who buy bulk phosphatidylserine (PS) and need to review peroxide value and oxidation quality evidence before batch approval.
- Content goal: Answer the real buyer question of what peroxide value measures in a PS powder, how to read the unit and method on a COA, how to compare limits across suppliers, and how to build oxidation quality checks into US and EU supplier qualification and receiving programs.
- Topic selection note: Today's first published article is the US-focused FDA import-alert and DWPE review (border screening after arrival) and the second is the China export documentation and ISPM-15 wood packaging review (pre-shipment logistics). This article intentionally moves to the analytical specification lane: peroxide value as an oxidation quality parameter on COAs and specifications. No existing resource is dedicated to peroxide value; the COA, shelf-life, and batch-calculation articles mention it only as a one-line list item, so there is no keyword cannibalization with the identity, heavy-metals, microbiological, residual-solvent, PAH, or third-party-testing articles.
- Primary Keyword: phosphatidylserine peroxide value
- Secondary Keywords: PS oxidation quality review, peroxide value mmol/kg meq/kg conversion, PS COA oxidation parameters, lecithin-derived PS oxidation control, PS batch oxidation trend review
- Long-tail Keywords:
  - what is a good peroxide value for phosphatidylserine
  - how to read peroxide value on a PS COA
  - what does a peroxide limit of 2.5 mmol/kg mean for PS buyers
  - how to compare peroxide value across PS suppliers
  - does the EU set a peroxide value limit for phospholipid ingredients
  - why does peroxide value matter in phosphatidylserine sourcing
- AI Overview / GEO Question Targets:
  - What is peroxide value and what does it measure in phosphatidylserine?
  - What peroxide value limit should a PS buyer require?
  - How do you read peroxide value on a phosphatidylserine COA?
  - How do mmol/kg and meq/kg units compare on a peroxide value report?
  - How should US and EU buyers build oxidation checks into PS supplier qualification?
- Search Intent: High-intent analytical specification review before batch approval, supplier comparison, and quality-agreement signoff
- Funnel Stage: Supplier qualification, specification review, batch approval, quality agreement, and incoming inspection
- SEO Title: Phosphatidylserine Peroxide Value and Oxidation Quality Review for US and EU Buyers | Nutranexa
- Meta Description: Read and compare phosphatidylserine peroxide value on COAs: units, methods, limits, and oxidation quality checks for US and EU supplier approval.
- URL Slug: /resources/phosphatidylserine-peroxide-value-review-us-eu/
- H1: Phosphatidylserine Peroxide Value and Oxidation Quality Review for US and EU Buyers

## Introduction

Peroxide value (PV) is one of the most useful quality parameters on a bulk [phosphatidylserine](/products/phosphatidylserine/) (PS) certificate of analysis, and one of the least explained. Buyers often ask: **what is a good peroxide value for PS, and how do I compare the number on my supplier's COA with another supplier's?** The direct answer: PV measures the peroxides formed when unsaturated fatty components oxidize, and a well-controlled lecithin-derived PS powder keeps results well below the stated limit, commonly 5-10 meq/kg in commercial specifications. On every COA, check three things: the unit, the method, and the batch result against the approved limit.
...
Nutranexa's public [PS product page](/products/phosphatidylserine/) includes a source and assay matrix in which the PS 20% sunflower and PS 50% routes list a peroxide value limit of **<= 2.5 mmol/kg**, equivalent to 5 meq/kg. The soy PS route is marked "confirm current specification," so buyers should request the current document for that source rather than assume the same limit.

The public COA samples on the [quality and R&D page](/quality-rd/) state **QB/T 5821-2023** as the test basis and report batch peroxide results against the <= 2.5 mmol/kg standard: 0.65 mmol/kg for a PS 20% sunflower sample, 1.05 mmol/kg for a PS 50% sample, 0.85 mmol/kg for a PS 50% sunflower sample, and 0.39 mmol/kg for a PS 70% batch sample. These are published batch samples, not permanent sales guarantees; request current batch COAs for each order. What they demonstrate is the evidence structure a buyer should expect: a stated limit, a named test basis, and a reported result per lot.
...
1. Confirm the PV row shows both a result and a stated limit.
2. Confirm the unit is stated and consistent with your approved specification.
3. Confirm the method or test basis is named on the COA.
4. Confirm the batch result is comfortably inside the limit, not borderline.
5. Ask for two to three recent batch results from the same product route.
6. Note the source (soy or sunflower) and confirm the COA matches the quoted product.
7. Confirm the same PV limit and unit appear in the quality agreement.
8. Confirm the incoming inspection procedure re-checks the COA against the approved spec.
9. Keep the PV row in your supplier comparison table so limits are compared on the same basis.
10. Escalate any unit mismatch, missing method, or unexplained result jump to the supplier's quality team before release.
...
In the United States, dietary supplement manufacturers operate under CGMPs in 21 CFR Part 111, which require establishing specifications for identity, purity, strength, composition, and limits on contaminants, and using appropriate test methods to verify those specifications. PV is not a contaminant in the classic sense, but the same logic applies: if your specification includes an oxidation parameter, the COA and test method need to support it. US buyers typically connect PV review to [supplier COA qualification](/resources/phosphatidylserine-supplier-coa-qualification-us/), [incoming inspection](/resources/phosphatidylserine-incoming-inspection-warehouse-release/), and the [supplier quality agreement](/resources/phosphatidylserine-supplier-quality-agreement-us-eu/).

In the European Union, there is no PS-specific PV regulation, and the E 322 lecithin benchmark is a reference rather than a requirement for PS. EU buyers usually handle PV through the approved specification, the supplier's COA, and finished-product quality control, often supported by [independent laboratory verification](/resources/phosphatidylserine-third-party-testing-us-eu/) on first lots. For both markets, PV review belongs in the same document workflow as [COA and specification approval](/resources/phosphatidylserine-coa-specification-certificate-review/) and [shelf-life and storage qualification](/resources/phosphatidylserine-shelf-life-storage-review-us-eu/), because oxidation results connect directly to how long the powder stays within specification.

Need current PS specifications and COA evidence for your oxidation review? [Request the specification and COA sample](/contact/) with your source preference, target assay, and destination market.

## Questions to Ask a PS Supplier About Oxidation Control

Add these questions to your RFQ and supplier questionnaire:

1. What peroxide value limit appears in the current specification, and in which unit?
2. Which test basis or method is used: QB/T 5821-2023, AOCS, or an internal method?
3. Can you provide the last three batch COAs for the quoted product route?
4. How do you control oxidation during storage, transport, and warehouse holding?
5. If a batch approaches the PV limit, what is your disposition process?
6. Will the quality agreement state the unit, method, and limit so COA review is consistent?
...
- [AOCS Official Method Cd 8-53, Peroxide Value Acetic Acid-Chloroform Method](https://library.aocs.org/Cd-8-53/)
- [AOCS Official Method Cd 8b-90, Peroxide Value Acetic Acid-Isooctane Method](https://library.aocs.org/Cd-8b-90/)
- [FDA GRAS Notice 636, Phosphatidylserine derived from sunflower lecithin](https://www.hfpappexternal.fda.gov/scripts/fdcc/index.cfm?id=636&set=grasnotices)
- [FAO JECFA: Lecithin, INS 322(i) specifications and monographs](https://www.fao.org/food/food-safety-quality/scientific-advice/jecfa/jecfa-additives/details-simple/en?ins_id=322%28i%29)
- [Legislation.gov.uk: Regulation (EU) 231/2012, Annex, E 322 Lecithins specification](https://www.legislation.gov.uk/eur/2012/231/annex/division/108/adopted/data.xht)
- [EUR-Lex: Commission Regulation (EU) 231/2012 on specifications for food additives](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32012R0231)
- [National Public Service Platform for Standards Information: QB/T 5821-2023](https://std.samr.gov.cn/hb/search/stdHBDetailed?id=099E5E9C51666C69E06397BE0A0ACA38)
...
- [BioFactors: Transbilayer distribution of aminophospholipids and the oxidative stability of their component polyunsaturated fatty acids](https://iubmb.onlinelibrary.wiley.com/doi/abs/10.1002/biof.552210145)
