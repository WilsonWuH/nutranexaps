...
function whatsappButton() {
  return `<a class="whatsapp-float" data-analytics-event="whatsapp_click" href="https://wa.me/${whatsapp.replace(/\D/g, "")}" target="_blank" rel="noopener noreferrer" aria-label="Contact Nutranexa on WhatsApp"><span>WhatsApp</span><strong>${whatsapp}</strong></a>`;
}
...
const promotedArticleVisuals = {
  ...
  "phosphatidylserine-organic-certification-review-us-eu": "Top-down organic certification review desk for phosphatidylserine with a blank certificate card showing an abstract green leaf seal, soy and sunflower source trays with leaf motifs, magnifier, pen, white powder dish, and sealed plain drum edge over a green field-pattern background",
  ...
  "phosphatidylserine-ppwr-packaging-europe": "Circular-economy packaging audit scene for European phosphatidylserine imports with a sealed plain 25 kilogram drum on a pallet at the left, a translucent plastic liner swatch held under a light beam at the centre, three sorting bins with abstract blank pictograms on the right, a blank EU Declaration of Conformity card under a magnifier, an abstract circular-arrows recycling loop around the drum, and a soft three-node timeline arc suggesting 2026 2028 and 2030 milestones in cool morning light with green and amber accents",
  ...
  "phosphatidylserine-dietary-supplement-listing-us": "Daylight U.S. regulatory-preparation desk for dietary supplement listing readiness with a sealed plain 25 kilogram phosphatidylserine drum on a pallet, an amber supplement bottle with a blank label, a blank electronic listing form card with abstract field rows under a magnifier, tabbed document file dividers for specification, COA, manufacturer identity, allergen, claims, and traceability, a database search motif, and soy and sunflower source trays",
  "phosphatidylserine-eu-official-controls-import-sampling": "EU import-control readiness desk with a sealed phosphatidylserine drum, intact lot label, clean sampling tools, blank shipping records, and a distant container terminal in natural morning light",
  "phosphatidylserine-haccp-supplier-hazard-analysis-eu": "European ingredient buyer and quality specialist reviewing a PS process hazard map beside a sealed drum, source trays, and stainless processing equipment in a real daylight plant office",
  "phosphatidylserine-one-step-traceability-file-eu": "European distributor traceability review with linked PS drum labels, receiving barcode scan, supplier and customer folders, and a pallet route through a daylight warehouse",
  "phosphatidylserine-multilingual-mandatory-food-information-europe": "European regulatory team reviewing blank multilingual label panels for soy and sunflower PS beside a sealed drum and unbranded supplement package in a daylight studio",
  "phosphatidylserine-importer-of-record-responsibilities-us-eu": "Cross-border PS entry review with a sealed drum, blank commercial invoice, broker handoff tray, port gate, and separate U.S. and EU route markers in realistic daylight",
  "phosphatidylserine-temperature-excursion-review-us-eu": "Bulk PS shipment excursion review in a daylight warehouse office with a sealed drum, temperature logger, insulated pallet wrap, blank deviation form, and quality hold tag",
  "phosphatidylserine-annual-volume-forecast-supplier-allocation": "Ingredient procurement planning meeting with PS grade samples, sealed drums, a blank rolling forecast board, pallet allocation cards, and a daylight manufacturing campus through glass",
  "phosphatidylserine-supplier-change-notification-qualification-triggers": "Supplier change-control meeting with soy and sunflower PS samples, sealed drum, blank revision cards, process equipment photographs, and quality reviewers in a daylight technical office",
  "phosphatidylserine-us-dietary-supplement-gmp-records-buyer-review": "U.S. supplement quality review with a sealed PS drum, retain sample jars, blank batch-record folders, sampling tools, and a capsule production room in realistic daylight",
  "phosphatidylserine-contract-packing-line-clearance-specification-handoff": "U.S. contract-packing line clearance at a clean supplement packaging room with a sealed PS drum, blank label roll, batch folder, barcode scanner, and operators checking equipment in natural industrial light",
  "phosphatidylserine-warehouse-receiving-sampling-plan-us": "U.S. warehouse receiving inspection with a pallet of sealed PS drums, clean sampling tools, barcode scanner, quarantine tag, retain jars, and a quality specialist under bright industrial daylight",
};
...
const promotedSeoTitles = {
  ...
  "phosphatidylserine-organic-certification-review-us-eu": "Phosphatidylserine Organic Certification Review | Nutranexa",
  ...
  "phosphatidylserine-dietary-supplement-listing-us": "Phosphatidylserine Dietary Supplement Listing Guide | Nutranexa",
  "phosphatidylserine-eu-official-controls-import-sampling": "PS EU Import Sampling Readiness Guide | Nutranexa",
  "phosphatidylserine-haccp-supplier-hazard-analysis-eu": "PS HACCP Supplier Hazard Analysis for Europe | Nutranexa",
  "phosphatidylserine-one-step-traceability-file-eu": "PS One-Step-Back Traceability File for Europe | Nutranexa",
  "phosphatidylserine-multilingual-mandatory-food-information-europe": "PS Multilingual Food Information Review for Europe | Nutranexa",
  "phosphatidylserine-importer-of-record-responsibilities-us-eu": "PS Importer of Record Responsibilities | US & EU Guide",
  "phosphatidylserine-temperature-excursion-review-us-eu": "PS Temperature-Excursion Review for US & EU Shipments | Nutranexa",
  "phosphatidylserine-annual-volume-forecast-supplier-allocation": "PS Annual Volume Forecast & Supplier Allocation | Nutranexa",
  "phosphatidylserine-supplier-change-notification-qualification-triggers": "PS Supplier Change Qualification Triggers | Nutranexa",
  "phosphatidylserine-us-dietary-supplement-gmp-records-buyer-review": "US Dietary Supplement GMP Records for PS Buyers | Nutranexa",
  "phosphatidylserine-contract-packing-line-clearance-specification-handoff": "PS Contract-Packing Line Clearance & Spec Handoff | Nutranexa",
  "phosphatidylserine-warehouse-receiving-sampling-plan-us": "PS Warehouse Receiving Sampling Plan | Nutranexa",
};

const promotedNewsSeoTitles = {
  "global-supplement-logistics-under-geopolitical-pressure-2026": "Supplement Logistics Risk Signals | Nutranexa News",
  "apac-nutra-brands-retail-and-innovation-roundup-2026": "APAC Nutra Brand & Format Signals | Nutranexa News",
  "heidi-overton-fda-nomination-supplement-industry-2026": "FDA Leadership Nomination Watch | Nutranexa News",
  "vitamin-c-gummy-marketplace-testing-quality-signal-2026": "Vitamin C Gummy Testing Signals | Nutranexa News",
  "echinacea-eu-novel-food-catalog-clarity-update-2026": "Echinacea Novel Food Update | Nutranexa News",
  "shatavari-extract-perimenopause-study-2026": "Shatavari Extract Study Update | Nutranexa News",
  "creatine-brain-bioavailability-evidence-review-2026": "Creatine Evidence Review | Nutranexa News",
  "children-supplement-formats-targeted-support-market-2026": "Children's Supplement Format Trends | Nutranexa News",
  "tailored-supplement-personalization-operating-system-2026": "Personalized Supplement Operations | Nutranexa News",
  "efsa-food-supplement-responsibility-framework-2026": "EFSA Food Supplement Responsibilities | Nutranexa News",
  "fda-yellow-oleander-alert-supply-chain-testing-2026": "FDA Yellow Oleander Alert | Nutranexa News",
  "fda-moringa-powder-salmonella-investigation-2026": "FDA Moringa Powder Investigation | Nutranexa News",
  "efsa-emerging-risk-horizon-scanning-food-supply-2026": "EFSA Emerging-Risk Scanning | Nutranexa News",
  "efsa-food-additive-risk-assessment-guidance-2026": "EFSA Food Additive Risk Guidance | Nutranexa News",
  "efsa-novel-food-application-dossier-workflow-2026": "Novel Food Dossier Workflow | Nutranexa News",
  "eu-packaging-recycling-rules-supplement-importers-2026": "EU Packaging Rules for Importers | Nutranexa News",
  "pragon-cjeu-ruling-food-supplement-single-market-2026": "CJEU Pragon Supplement Ruling | Nutranexa News",
  "wearables-supplement-brands-regulatory-classification-2026": "Wearables & Supplement Regulation | Nutranexa News",
  "uk-supplement-subscription-rules-january-2027-2026": "UK Supplement Subscription Rules | Nutranexa News",
  "polyunsaturated-fatty-acid-cracker-randomized-trial-2026": "Fatty-Acid Cracker Trial | Nutranexa News",
  "mfgm-phospholipids-early-brain-development-review-2026": "MFGM Phospholipid Research Review | Nutranexa News",
  "mfgm-phospholipid-nutrition-review-frontiers-2026": "MFGM Phospholipid Nutrition Review | Nutranexa News",
  "efsa-anaerobutyricum-soehngenii-novel-food-opinion-2026": "EFSA Anaerobutyricum Opinion | Nutranexa News",
  "efsa-plukenetia-volubilis-roasted-seeds-traditional-food-2026": "EFSA Plukenetia Seed Update | Nutranexa News",
  "efsa-lacto-n-triose-ii-novel-food-opinion-2026": "EFSA Lacto-N-Triose II Opinion | Nutranexa News",
  "efsa-zinc-l-carnosine-novel-food-supplement-opinion-2026": "EFSA Zinc L-Carnosine Opinion | Nutranexa News",
  "fda-dietary-supplement-compliance-program-identity-labeling-2026": "FDA Supplement Compliance Program | Nutranexa News",
  "ai-sports-nutrition-recommendations-search-visibility-2026": "AI Sports Nutrition Visibility | Nutranexa News",
  "personalized-powder-blends-yutrients-market-update-2026": "Personalized Powder Blend Update | Nutranexa News",
  "eye-health-supplement-launches-targeted-formats-2026": "Targeted Eye-Health Formats | Nutranexa News",
};
...
function qualificationPackHref(extra = {}) {
  const params = new URLSearchParams({ request: "qualification-pack", ...extra });
  return `/contact/?${params.toString()}`;
}

function qualificationPackCta({ label = "Request Qualification Pack", className = "button primary", sourcePage = "" } = {}) {
  return `<a class="${esc(className)}" data-analytics-event="qualification_pack_click" data-source-page="${esc(sourcePage)}" href="${qualificationPackHref()}">${esc(label)}</a>`;
}
            ...
            ${item.columns
              .map(
                (column) => `<div class="mega-column">
                  <h3>${column.title}</h3>
                  ${column.links.map(([label, href]) => `<a class="mega-link" href="${href}"><span>${label}</span></a>`).join("")}
                </div>`,
              )
              .join("")}
          </div>
...
function companyVideoPlayer(className = "company-video-player") {
  return `<figure class="${esc(className)}">
    <video data-analytics-event="factory_video_start" controls playsinline preload="metadata" poster="/assets/images/nutranexa-company-video-poster.webp" width="1280" height="720" aria-label="Nutranexa company and manufacturing introduction video">
...
function quoteForm(context = "General inquiry", _note = "", options = {}) {
  const requestType = options.includeRequestType
    ? `<label>Request Type <select name="Request Type"><option value="">Select request type</option><option>Qualification Pack</option><option>Quote</option><option>Sample</option><option>Specification</option><option>COA</option><option>Technical Support</option><option>Distributor Inquiry</option><option>Other</option></select></label>`
    : "";
  ...
  <div class="form-grid">
    ...
    ${targetField}
    ${requestType}
    <label>Estimated Annual Volume <select name="Estimated Annual Volume"><option value="">Select annual volume</option><option>Sample</option><option>25–100 kg</option><option>100–500 kg</option><option>500 kg–1 MT</option><option>1–5 MT</option><option>Above 5 MT</option><option>Not decided</option></select></label>
    <fieldset class="form-full document-choice"><legend>Required Documents</legend><label><input type="checkbox" name="Documents Needed" value="Specification"> Specification</label><label><input type="checkbox" name="Documents Needed" value="COA"> COA</label><label><input type="checkbox" name="Documents Needed" value="TDS"> TDS</label><label><input type="checkbox" name="Documents Needed" value="SDS"> SDS</label><label><input type="checkbox" name="Documents Needed" value="MSDS"> MSDS</label><label><input type="checkbox" name="Documents Needed" value="Allergen Information"> Allergen Information</label><label><input type="checkbox" name="Documents Needed" value="GMO Statement"> GMO Statement</label><label><input type="checkbox" name="Documents Needed" value="Halal"> Halal</label><label><input type="checkbox" name="Documents Needed" value="Kosher"> Kosher</label></fieldset>
  ...
  <button class="button primary" type="submit">Request Qualification Pack</button>
...
function coaSampleTables(samples = coaSamples) {
  return `<div class="coa-grid">${samples.map((sample) => `<article class="coa-card"><a class="coa-image-link" data-analytics-event="document_preview" data-document-type="COA" href="${sample.image}" target="_blank" rel="noopener"><img src="${sample.image}" alt="${esc(sample.title)}" loading="lazy"></a><div><h3>${esc(sample.title)}</h3><table><tbody>${sample.rows.map(([label, value]) => `<tr><th>${esc(label)}</th><td>${esc(value)}</td></tr>`).join("")}</tbody></table><p class="form-note">Sample COA data is batch-specific. Current batch COA should be confirmed before quotation or shipment.</p><a class="document-link" data-analytics-event="document_preview" data-document-type="COA" href="${sample.image}" target="_blank" rel="noopener">View full COA sample</a></div></article>`).join("")}</div>`;
}
...
function nxHomePage() {
  ...
  const heroFacts = [
    ...
    .join("");
  const gradeCards = [
    { slug: "phosphatidylserine-20", name: "Phosphatidylserine 20%", shortName: "PS 20%", tag: "Flexible formulation grade", meta: "Soy / Sunflower · Powder · 20% assay", image: "/assets/images/product-soy-ps-480.webp", w: 480, h: 480 },
    { slug: "phosphatidylserine-50", name: "Phosphatidylserine 50%", shortName: "PS 50%", tag: "Our mainstream high-concentration grade", meta: "Soy / Sunflower · Powder · 50% assay", image: "/assets/images/product-powder-spoon.webp", w: 700, h: 700 },
    { slug: "phosphatidylserine-70", name: "Phosphatidylserine 70%", shortName: "PS 70%", tag: "High-purity PS for advanced formulations", meta: "Soy / Sunflower · Powder · 70% assay", image: "/assets/images/product-sunflower-ps-480.webp", w: 480, h: 480 },
  ];
  const gradeCardHtml = gradeCards
    .map(
      (grade) => `<article class="nx-grade-card">
  ...
  const aboutFacts = [
    ...
    [nxIcon.drum, "110,000+ m&sup2;", "Manufacturing Campus"],
    [nxIcon.globe, "Global", "Export Markets"],
  ...
  <section class="nx-section nx-about">
...
function psGradePage(grade) {
  if (grade.slug === "phosphatidylserine-50") return ps50Page(grade);
...
function ps50Page(grade) {
  ...
  const appCards = [
    ...
    .join("");
  const sourceChecks = {
    soy: ["Established supply route", "Commonly used source", "Suitable for many markets", "Non-GMO documentation available"],
    sunflower: ["Alternative plant source", "Non-soy option", "Suitable for different market positioning", "Non-GMO documentation available"],
  };
  const sourceCol = (key, name, href, image, alt, style) => `<div class="nx-source-col">
          <img src="${image}" alt="${esc(alt)}" width="700" height="700" loading="lazy" decoding="async"${style ? ` style="${style}"` : ""}>
          <h3>${esc(name)}</h3>
  ...
  const specRows = [
    ["Product name", "Phosphatidylserine 50%"],
    ["Source", "Soy or Sunflower"],
    ["Appearance", "Light yellow to yellow powder"],
    ["Assay (Phosphatidylserine)", "50% target grade (typical, as-is basis)"],
    ["Moisture", "&le; 2.0%"],
    ["Peroxide value", "&le; 2.5 mmol/kg"],
  ...
  const docRows = [
    ["/assets/images/doc-coa-ps-50.webp", "Sample COA (PDF)"],
    [documentsHref, "Specification (PDF)"],
    [documentsHref, "TDS (PDF)"],
    [documentsHref, "SDS (PDF)"],
    [documentsHref, "Allergen (PDF)"],
    ...
    .join("");
  const ps50Faqs = [
    ["What is phosphatidylserine 50% used for?", "PS 50% is a concentration-focused phosphatidylserine grade used in dietary supplements and functional nutrition formats such as capsules, tablets, and powder blends. Application fit should be confirmed through your formulation, processing, and stability review."],
    ["Is your PS50 from soy or sunflower?", "Both source routes are available. Confirm the source for your quotation and request the source statement with the current batch documentation before approval."],
    ["What is the typical lead time and MOQ?", "The standard MOQ is 25 kg — one 25 kg net drum. Production and delivery lead times are confirmed with the quotation for your destination market and order volume."],
    ["Which documents can you provide?", "Buyers can request the current specification, batch COA, TDS, SDS, allergen information, and Halal or Kosher certificates. Documents are always matched to the quoted product, source, and batch."],
    ["Do you offer non-GMO PS50?", "GMO statements are available for the quoted product. Confirm the current non-GMO documentation options for your source route and destination market with our team."],
    ["Can you support custom specifications?", "Discuss your target assay, source, packaging, and application with our technical support team. Custom requirements are confirmed against production and QC capability before quotation."],
  ];
  const gradeGuide = `<section class="nx-section nx-grades-guide"><div class="nx-shell">
    ${sectionIntro("Grade decision guide", "How buyers should evaluate PS 50%", "PS 50% describes the target phosphatidylserine concentration; source, carrier, test method, and current product documents still determine whether a quoted material fits the project.")}
    <div class="detail-grid"><div><h3>What PS 50% means</h3><p>PS 50% is a concentration or grade reference, not a source claim. Confirm whether the quoted material is soy-derived, sunflower-derived, or another documented route, then match the source and grade to the label and market brief.</p></div><div><h3>How PS content is tested</h3><p>Use the assay method and acceptance limit stated in the current controlled specification or batch COA. Request the test basis, lot number, report date, and any external laboratory reference before qualification.</p></div><div><h3>Application fit</h3><p>PS 50% may be considered for capsules, tablets, powders, and functional nutrition concepts where the target serving, carrier, flow, moisture, oxidation control, and stability plan have been tested.</p></div><div><h3>Documentation to request</h3><p>Request the current specification, batch-specific COA, source statement, allergen information, TDS, MSDS, packaging, MOQ, and market-specific files where applicable.</p></div></div>
    <div class="table-wrap"><table class="spec-table"><thead><tr><th>Grade route</th><th>Buyer consideration</th></tr></thead><tbody>
      <tr><th>PS 20%</th><td>Lower concentration route; compare serving size, carrier, processing behavior, and current source-specific specification.</td></tr>
      <tr><th>PS 50%</th><td>Concentration-focused route for projects seeking a higher assay; verify assay method, source, batch result, and application fit.</td></tr>
    ...
    <div class="section-actions"><a class="button secondary" href="/products/phosphatidylserine-20/">Review PS 20%</a><a class="button secondary" href="/products/phosphatidylserine-70/">Review PS 70%</a><a class="button secondary" href="/products/soy-phosphatidylserine/">Review soy-source PS</a><a class="button secondary" href="/products/sunflower-phosphatidylserine/">Review sunflower-source PS</a></div>
  </div></section>`;
  ...
  <section class="nx-section nx-spec">
    <div class="nx-shell nx-spec-grid">
      ...
      <aside class="nx-source-panel" aria-labelledby="nx-ps50-sources-title">
        <h2 id="nx-ps50-sources-title">Two Plant Sources</h2>
  ...
  <section class="nx-section nx-apps">
    <div class="nx-shell">
      <div class="nx-section-head"><div><h2>Applications</h2><p class="nx-section-sub">Phosphatidylserine 50% is widely used in dietary supplements and functional nutrition products.</p></div><a class="nx-textlink" href="/applications/">View All Applications &rarr;</a></div>
  ...
  <section class="nx-section nx-mfgq">
    <div class="nx-shell nx-mfgq-grid">
      ...
      <aside class="nx-source-panel nx-batch-panel" aria-labelledby="nx-ps50-batch-title">
        <h2 id="nx-ps50-batch-title">Real Batch Documentation</h2>
        <p class="nx-section-sub">Sample COAs are historical batch references. Request the current specification and batch documentation for your project.</p>
        <a class="nx-coa-thumb" href="/assets/images/doc-coa-ps-50.webp" target="_blank" rel="noopener"><img src="/assets/images/doc-coa-ps-50.webp" alt="PS 50% sample certificate of analysis" width="1200" height="1698" loading="lazy" decoding="async"><span>PS 50% Sample COA</span></a>
  ...
  <section class="nx-section nx-faq">
    <div class="nx-shell">
      ...
      <div class="faq-list nx-faq-list">${ps50Faqs.map(([q, a]) => `<details><summary>${esc(q)}</summary><p>${esc(a)}</p></details>`).join("")}</div>
    </div>
  </section>
  ${gradeGuide}
  <nav class="nx-linkband" aria-label="Related pages">
    <div class="nx-shell">
      ...
      <a href="/resources/phosphatidylserine-guide/">PS Buying Guide</a>
      <a href="/resources/documents-for-ps-ingredients/">Technical documents</a>
  ...
  return layout({
    ...
    schema: [breadcrumbJson([["Home", "/"], ["Products", "/products/"], [grade.name, route]]), {
      "@context": "https://schema.org",
      "@type": "FAQPage",
      mainEntity: ps50Faqs.map(([q, a]) => ({ "@type": "Question", name: q, acceptedAnswer: { "@type": "Answer", text: a } })),
    }],
    body,
  });
}
...
function companyVerificationPage() {
  ...
  <section class="verification-section" aria-labelledby="document-availability-title"><div>${sectionIntro("Document Availability", "Request the files needed for supplier qualification", "Current controlled documents are supplied through the inquiry workflow and should be matched to the exact product, source, batch, and destination market.", "document-availability-title")}</div><div class="verification-document-grid"><article><h3>Product and batch</h3><p>Specification, COA sample or current batch COA, TDS, SDS, packaging, storage, and shelf-life information.</p><a data-analytics-event="document_preview" data-document-type="quality-guidance" href="/quality-rd/">Review quality guidance &rarr;</a></article><article><h3>Market and label review</h3><p>Allergen, GMO, Halal, Kosher, and market-specific files where applicable and currently available.</p><a data-analytics-event="qualification_pack_click" data-source-page="company-verification-documents" href="${qualificationPackHref()}">Request a qualification pack &rarr;</a></article></div></section>
  <section class="verification-section verification-review" aria-labelledby="last-reviewed-title"><div>${sectionIntro("Last Reviewed", `Public references reviewed on ${companyIdentity.lastReviewed}`, "The date records this page's content review. It does not certify that a third-party page, certificate, or licence has no subsequent change; confirm the current version as part of qualification.", "last-reviewed-title")}</div><p><time datetime="${esc(companyIdentity.lastReviewed)}">${esc(companyIdentity.lastReviewed)}</time></p></section>
...
function newsArticlePage(article) {
  ...
  return plainNewsArticleLayout({
    title: promotedNewsSeoTitles[article.slug] || `${article.headline} | Nutranexa News`,
    description: conciseMeta(article.description),
    route,
...
await add("/company-verification/", companyVerificationPage());
